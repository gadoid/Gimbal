"""fin.handover_form.list_page —— 孪生生成器产物(请求面;行为面归场景用例)。
...
HANDOVER_FORM_LIST_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.handover_form.list_page',
    system='fin',
    service='fin-service',
    name='HandoverForm.listPage',
    description='HandoverForm.listPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/customer/handoverForm/listPage',
        headers={},
        consumes=[],
        produces=[],
    ),
