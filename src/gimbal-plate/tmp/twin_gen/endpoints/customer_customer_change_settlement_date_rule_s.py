"""fin.customer.change_settlement_date_rule_s —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): customer_id, settlement_date
溯源统计: column=7, lang=1, 无zh=1 | fe_high=0, enum=1
"""
...
CUSTOMER_CHANGE_SETTLEMENT_DATE_RULE_S: Final[EndpointSpec] = EndpointSpec(
    id='fin.customer.change_settlement_date_rule_s',
    system='fin',
    service='fin-service',
    name='操作目的',
    ...
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/customer/customer/changeSettlementDateRuleS',
        headers={},
        consumes=[],
        produces=[],
    ),
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='settlement_date', path=f'$.settlement_date', type='string', state='form', ui_kind='text', default='10', description='客户结算日'),  # zh_ambiguous
