"""fin.relate.relate_page —— 孪生生成器产物(请求面;行为面归场景用例)。
...
RELATE_RELATE_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.relate.relate_page',
    system='fin',
    service='fin-service',
    name='Relate.relatePage',
    description='Relate.relatePage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/customer/relate/relatePage',
        headers={},
        consumes=[],
        produces=[],
    ),
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='has_effective_account', path=f'$.has_effective_account', type='string', state='form'),
