...
RECEIVE_INVOICE_INVOICE_ADD: Final[EndpointSpec] = EndpointSpec(
    id='fin.receive_invoice.invoice_add',
    system='fin',
    service='fin-service',
    name='ReceiveInvoice.invoiceAdd',
    description='ReceiveInvoice.invoiceAdd' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
