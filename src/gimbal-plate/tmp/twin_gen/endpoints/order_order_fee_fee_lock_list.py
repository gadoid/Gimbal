"""fin.order_fee.fee_lock_list —— 孪生生成器产物(请求面;行为面归场景用例)。
...
ORDER_FEE_FEE_LOCK_LIST: Final[EndpointSpec] = EndpointSpec(
    id='fin.order_fee.fee_lock_list',
    system='fin',
    service='fin-service',
    name='OrderFee.feeLockList',
    description='OrderFee.feeLockList' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/order/orderFee/feeLockList',
        headers={},
        consumes=[],
        produces=[],
    ),
