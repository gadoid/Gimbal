"""fin.order_order.order_add —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): customer_id, service_id, client_expand_id, customer_contact_id, main_sort, service_items, business_type, carrier, track_bl_no, pol, pot, pod, del, country_name, terms_payment, terms_transport, pay_type, customer_order_sn, cargo_type, num, gross_weight, packer, status, ship_mark, commodity, notes, terms_shipment, remark, customer_contact_name, ocean_type, order_id, order_self_id, customer_address_cn, customer_contact_phone, pol_cn, pol_country, pol_country_cn, pod_cn, pot_cn, del_cn, discount_rule, discount_ratio, discount_currency, fee_miss_name, effective_by, audit_type, customer_put_date_desc
溯源统计: column=135, rule=46, lang=21, 无zh=10, derived=2, header=1 | fe_high=84, enum=2
"""
...
ORDER_ORDER_ADD: Final[EndpointSpec] = EndpointSpec(
    ...
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='service_id', path=f'$.service_id', type='integer', state='carry', ui_kind='number', default='0', description='客服ID'),  # needs_capture:value_source
            DeclarationEntry(name='client_expand_id', path=f'$.client_expand_id', type='integer', state='carry', ui_kind='number', default='0', description='直客拓展ID'),  # needs_capture:value_source
            DeclarationEntry(name='customer_contact_id', path=f'$.customer_contact_id', type='integer', state='carry', ui_kind='number', default='0', description='客户联系人id'),  # needs_capture:value_source
            ...
            DeclarationEntry(name='carrier', path=f'$.carrier', type='string', state='carry', ui_kind='text', description='船公司/承运人'),  # needs_capture:value_source
            DeclarationEntry(name='bl_no', path=f'$.bl_no', type='string', state='carry', ui_kind='text', description='提单号', value_source=ValueSource(view='pending_orders', column='bl_no'), source_kind='lookup'),
            ...
            DeclarationEntry(name='pol', path=f'$.pol', type='string', state='carry', ui_kind='text', description='起运港'),  # needs_capture:value_source
            DeclarationEntry(name='pot', path=f'$.pot', type='string', state='carry', ui_kind='text', description='中转港'),  # needs_capture:value_source
            DeclarationEntry(name='pod', path=f'$.pod', type='string', state='carry', ui_kind='text', description='卸货港'),  # needs_capture:value_source
            DeclarationEntry(name='del', path=f'$.del', type='string', state='carry', ui_kind='text', description='目的地'),  # needs_capture:value_source
            ...
            DeclarationEntry(name='cargo_type', path=f'$.cargo_type', type='string', state='carry', ui_kind='text', description='货物类型'),  # needs_capture:value_source
            DeclarationEntry(name='num', path=f'$.num', type='integer', state='carry', ui_kind='number', description='件数'),  # zh_ambiguous, needs_capture:value_source
            DeclarationEntry(name='gross_weight', path=f'$.gross_weight', type='number', state='carry', ui_kind='number', description='毛重'),  # needs_capture:value_source
            ...
            DeclarationEntry(name='volume_desc', path=f'$.volume_desc', type='string', state='form', ui_kind='text', description='箱型箱量描述'),
            DeclarationEntry(name='container', path=f'$.container', type='array', state='form', ui_kind='unknown', description='箱型',
                children=[
            ...
            DeclarationEntry(name='status', path=f'$.status', type='integer', state='form', ui_kind='select', default='2', description='订单状态', enum=['1', '2']),  # zh_ambiguous
            ...
            DeclarationEntry(name='sale_id', path=f'$.sale_id', type='integer', state='carry', ui_kind='number', default='0', description='销售ID'),
            ...
            DeclarationEntry(name='airline_type', path=f'$.airline_type', type='string', state='form', ui_kind='text', description='航线分类'),
            ...
            DeclarationEntry(name='book_supplier_id', path=f'$.book_supplier_id', type='integer', state='carry', ui_kind='number', default='0', description='订舱供应商'),
            ...
            DeclarationEntry(name='state', path=f'$.state', type='string', state='form', ui_kind='text'),
            DeclarationEntry(name='financing_continue', path=f'$.financing_continue', type='string', state='form', ui_kind='text'),
