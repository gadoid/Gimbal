...
PAY_INVOICE_INVOICE_EXPORT: Final[EndpointSpec] = EndpointSpec(
    id='fin.pay_invoice.invoice_export',
    system='fin',
    service='fin-service',
    name='PayInvoice.invoiceExport',
    description='PayInvoice.invoiceExport' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/payInvoice/invoiceExport',
        headers={},
        consumes=[],
        produces=[],
    ),
