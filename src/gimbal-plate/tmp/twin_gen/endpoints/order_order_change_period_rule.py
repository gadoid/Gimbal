"""fin.order.change_period_rule —— 孪生生成器产物(请求面;行为面归场景用例)。
...
ORDER_CHANGE_PERIOD_RULE: Final[EndpointSpec] = EndpointSpec(
    id='fin.order.change_period_rule',
    system='fin',
    service='fin-service',
    name='操作目的',
    ...
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='isChangeConfirmed', path=f'$.isChangeConfirmed', type='string', state='form'),
