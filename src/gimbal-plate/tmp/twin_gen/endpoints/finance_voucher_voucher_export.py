"""fin.finance_voucher.voucher_export —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): order_fee_real_id
溯源统计: 无zh=2, builtin=2, column=2 | fe_high=0, enum=0
"""
...
VOUCHER_VOUCHER_EXPORT: Final[EndpointSpec] = EndpointSpec(
    id='fin.finance_voucher.voucher_export',
    system='fin',
    service='fin-service',
