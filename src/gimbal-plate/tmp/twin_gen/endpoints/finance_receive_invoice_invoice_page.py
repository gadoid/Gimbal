...
RECEIVE_INVOICE_INVOICE_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.receive_invoice.invoice_page',
    system='fin',
    service='fin-service',
    name='ReceiveInvoice.invoicePage',
    description='ReceiveInvoice.invoicePage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/receiveInvoice/invoicePage',
        headers={},
        consumes=[],
        produces=[],
    ),
