"""fin.relate.relate_edit —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): relate_no, customer_id, supplier_id, period_date_start, period_date_end, settle_type, period_rule
溯源统计: column=42, 无zh=28, lang=5, derived=2 | fe_high=19, enum=1
"""
...
RELATE_RELATE_EDIT: Final[EndpointSpec] = EndpointSpec(
    id='fin.relate.relate_edit',
    system='fin',
    service='fin-service',
    name='操作目的',
    ...
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/customer/relate/relateEdit',
        headers={},
        consumes=[],
        produces=[],
    ),
