"""fin.order.batch_change_related —— 孪生生成器产物(请求面;行为面归场景用例)。
...
ORDER_BATCH_CHANGE_RELATED: Final[EndpointSpec] = EndpointSpec(
    id='fin.order.batch_change_related',
    system='fin',
    service='fin-service',
    ...
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='client_expand', path=f'$.client_expand', type='string', state='form', description='服务团队—直客拓展'),
