"""fin.order.other_order_detail —— 孪生生成器产物(请求面;行为面归场景用例)。
...
ORDER_OTHER_ORDER_DETAIL: Final[EndpointSpec] = EndpointSpec(
    id='fin.order.other_order_detail',
    system='fin',
    service='fin-service',
    ...
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='reverse_status_name', path=f'$.reverse_status_name', type='string', state='form'),
            DeclarationEntry(name='reverse_status', path=f'$.reverse_status', type='integer', state='form', default='0', description='是否倒找 0否1是'),
            DeclarationEntry(name='is_delayed_recovery_name', path=f'$.is_delayed_recovery_name', type='string', state='form'),
            ...
            DeclarationEntry(name='order_finance_arr', path=f'$.order_finance_arr', type='string', state='form'),
            DeclarationEntry(name='order_main_bank_arr', path=f'$.order_main_bank_arr', type='string', state='form'),
            DeclarationEntry(name='order_sub', path=f'$.order_sub', type='string', state='form'),
            ...
            DeclarationEntry(name='real_fee_locked', path=f'$.real_fee_locked', type='integer', state='form', default='0', description='实际费用是否锁定过  0否1是'),
            ...
            DeclarationEntry(name='policy_main_arr', path=f'$.policy_main_arr', type='string', state='form'),
            ...
            DeclarationEntry(name='audit', path=f'$.audit', type='string', state='form'),
            DeclarationEntry(name='enable', path=f'$.enable', type='string', state='form'),
            ...
            DeclarationEntry(name='real_discount_status_name', path=f'$.real_discount_status_name', type='string', state='form'),
            DeclarationEntry(name='real_discount_status', path=f'$.real_discount_status', type='integer', state='form', default='0', description='实际费用费用折扣标识   0正常  1异常  2全不参与补贴 3不符合的折扣规则 4折扣规则过期 5未维护ATD'),
            DeclarationEntry(name='expect_discount_status_name', path=f'$.expect_discount_status_name', type='string', state='form'),
            DeclarationEntry(name='expect_discount_status', path=f'$.expect_discount_status', type='integer', state='form', default='0', description='预估费用折扣标识   0正常  1异常  2全不参与补贴 3不符合的折扣规则 4折扣规则过期 5未维护ATD'),
            DeclarationEntry(name='expect_policy_status_name', path=f'$.expect_policy_status_name', type='string', state='form'),
            DeclarationEntry(name='policy_status_name', path=f'$.policy_status_name', type='string', state='form'),
            DeclarationEntry(name='subsidy_category_name', path=f'$.subsidy_category_name', type='string', state='form'),
            DeclarationEntry(name='expect_subsidy_category_name', path=f'$.expect_subsidy_category_name', type='string', state='form'),
            DeclarationEntry(name='real_subsidy_category_name', path=f'$.real_subsidy_category_name', type='string', state='form'),
            DeclarationEntry(name='revoke_status_name', path=f'$.revoke_status_name', type='string', state='form'),
            ...
            DeclarationEntry(name='revoke_type_name', path=f'$.revoke_type_name', type='string', state='form'),
            DeclarationEntry(name='asset_status_name', path=f'$.asset_status_name', type='string', state='form'),
            DeclarationEntry(name='asset_status', path=f'$.asset_status', type='integer', state='form', description='资产状态 1可撤回 2不可撤回'),
        ],
    ),
    responses={
        200: ResponseSpec(
