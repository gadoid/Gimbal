"""fin.order_order.other_order_detail —— 孪生生成器产物(请求面;行为面归场景用例)。
...
ORDER_OTHER_ORDER_DETAIL: Final[EndpointSpec] = EndpointSpec(
    id='fin.order_order.other_order_detail',
    system='fin',
    service='fin-service',
    name='Order.otherOrderDetail',
    description='Order.otherOrderDetail' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/order/order/otherOrderDetail',
        headers={},
        consumes=[],
        produces=[],
    ),
