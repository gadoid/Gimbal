"""fin.order_entrust.order_export —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): customer_id, order_no, status, service_project, customer_put_date, create_time, currency, fee_type, fund_code, create_id, invoice_number, track_bl_no, pay_status, fee_lock_status, discount_status
溯源统计: lang=33, column=27, frontend=20, 无zh=17, derived=13, frontend_label=3, header=1 | fe_high=28, enum=1
"""
...
ORDER_ENTRUST_ORDER_EXPORT: Final[EndpointSpec] = EndpointSpec(
    id='fin.order_entrust.order_export',
    system='fin',
    service='fin-service',
    name='OrderEntrust.orderExport',
    description='OrderEntrust.orderExport' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/order/orderEntrust/orderExport',
        headers={},
        consumes=[],
        produces=[],
    ),
