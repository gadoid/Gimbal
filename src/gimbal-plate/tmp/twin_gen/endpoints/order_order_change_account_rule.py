"""fin.order_order.change_account_rule —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): order_id, customer_id, flow_type
溯源统计: column=9, lang=5, 无zh=5, header=1 | fe_high=0, enum=1
"""
...
ORDER_CHANGE_ACCOUNT_RULE: Final[EndpointSpec] = EndpointSpec(
    id='fin.order_order.change_account_rule',
    system='fin',
    service='fin-service',
    name='操作',
    ...
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='supplier_period', path=f'$.supplier_period', type='integer', state='form', ui_kind='number', default='0', description='供应商账期'),
