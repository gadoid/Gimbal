"""fin.cost.cost_page —— 孪生生成器产物(请求面;行为面归场景用例)。
...
COST_COST_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.cost.cost_page',
    system='fin',
    service='fin-service',
    name='Cost.costPage',
    description='Cost.costPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/home/cost/costPage',
        headers={},
        consumes=[],
        produces=[],
    ),
