"""fin.handover_form.supplier_page —— 孪生生成器产物(请求面;行为面归场景用例)。
...
HANDOVER_FORM_SUPPLIER_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.handover_form.supplier_page',
    system='fin',
    service='fin-service',
    name='HandoverForm.supplierPage',
    description='HandoverForm.supplierPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/customer/handoverForm/supplierPage',
        headers={},
        consumes=[],
        produces=[],
    ),
