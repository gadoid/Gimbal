"""fin.pay_account.order_pay_account_edit —— 孪生生成器产物(请求面;行为面归场景用例)。
...
PAY_ACCOUNT_ORDER_PAY_ACCOUNT_EDIT: Final[EndpointSpec] = EndpointSpec(
    id='fin.pay_account.order_pay_account_edit',
    system='fin',
    service='fin-service',
    name='操作',
    ...
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/payAccount/orderPayAccountEdit',
        headers={},
        consumes=[],
        produces=[],
    ),
