"""fin.pay_writeoff.writeoff_page —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): pay_invoice_apply_no, pay_invoice_batch_no, create_time, cancel_status, link_audit_status, customer_id, main_id, pay_settle_object_id, currency, invoice_status, invoice_no, writeoff_status, create_id, receive_invoice_batch_no, pay_writeoff_no, receive_invoice_apply_no, put_settle_object_id, sort_field, sort_order
溯源统计: frontend=34, derived=6, column=5, builtin=4, lang=1, 无zh=1 | fe_high=35, enum=1
"""
...
PAY_WRITEOFF_WRITEOFF_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.pay_writeoff.writeoff_page',
    system='fin',
    service='fin-service',
    name='PayWriteoff.writeoffPage',
    description='PayWriteoff.writeoffPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/payWriteoff/writeoffPage',
        headers={},
        consumes=[],
        produces=[],
    ),
