...
PAY_WRITEOFF_WRITEOFF_PAGE: Final[EndpointSpec] = EndpointSpec(
    ...
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='pay_writeoff_id', path=f'$.pay_writeoff_id', type='string', state='form', description='核销ID'),
            ...
            DeclarationEntry(name='receive_writeoff_no', path=f'$.receive_writeoff_no', type='string', state='form', description='应收核销记录编号'),
