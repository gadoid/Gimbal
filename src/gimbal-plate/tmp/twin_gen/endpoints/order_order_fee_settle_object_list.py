"""fin.order_fee.settle_object_list —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): order_id, service_project, page_no, page_size, sort_field, sort_order
...
ORDER_FEE_SETTLE_OBJECT_LIST: Final[EndpointSpec] = EndpointSpec(
    id='fin.order_fee.settle_object_list',
    system='fin',
    service='fin-service',
    name='OrderFee.settleObjectList',
    description='OrderFee.settleObjectList' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/order/orderFee/settleObjectList',
        headers={},
        consumes=[],
        produces=[],
    ),
