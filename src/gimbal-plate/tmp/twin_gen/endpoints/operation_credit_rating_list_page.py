"""fin.credit_rating.list_page —— 孪生生成器产物(请求面;行为面归场景用例)。
...
CREDIT_RATING_LIST_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.credit_rating.list_page',
    system='fin',
    service='fin-service',
    name='CreditRating.listPage',
    description='CreditRating.listPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/operation/creditRating/listPage',
        headers={},
        consumes=[],
        produces=[],
    ),
