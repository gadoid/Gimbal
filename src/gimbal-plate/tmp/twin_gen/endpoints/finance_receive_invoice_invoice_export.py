"""fin.receive_invoice.invoice_export —— 孪生生成器产物(请求面;行为面归场景用例)。
...
溯源统计: frontend=22, derived=10, lang=6, column=4, 无zh=3 | fe_high=27, enum=0
"""
...
RECEIVE_INVOICE_INVOICE_EXPORT: Final[EndpointSpec] = EndpointSpec(
    id='fin.receive_invoice.invoice_export',
    system='fin',
    service='fin-service',
    name='ReceiveInvoice.invoiceExport',
    description='ReceiveInvoice.invoiceExport' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/receiveInvoice/invoiceExport',
        headers={},
        consumes=[],
        produces=[],
    ),
