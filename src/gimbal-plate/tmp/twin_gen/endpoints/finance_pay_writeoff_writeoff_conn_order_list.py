"""fin.pay_writeoff.writeoff_conn_order_list —— 孪生生成器产物(请求面;行为面归场景用例)。
...
PAY_WRITEOFF_WRITEOFF_CONN_ORDER_LIST: Final[EndpointSpec] = EndpointSpec(
    id='fin.pay_writeoff.writeoff_conn_order_list',
    system='fin',
    service='fin-service',
    name='PayWriteoff.writeoffConnOrderList',
    description='PayWriteoff.writeoffConnOrderList' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/payWriteoff/writeoffConnOrderList',
        headers={},
        consumes=[],
        produces=[],
    ),
