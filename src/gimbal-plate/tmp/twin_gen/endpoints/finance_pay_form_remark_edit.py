"""fin.pay_form.remark_edit —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): remark, pay_form_no, pay_settle_object_address, pay_settle_object_receive_account, statement_receipt_time, cancel_by
溯源统计: column=39, 无zh=2, lang=1 | fe_high=0, enum=0
"""
...
PAY_FORM_REMARK_EDIT: Final[EndpointSpec] = EndpointSpec(
    id='fin.pay_form.remark_edit',
    system='fin',
    service='fin-service',
    name='PayForm.remarkEdit',
    description='PayForm.remarkEdit' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/payForm/remarkEdit',
        headers={},
        consumes=[],
        produces=[],
    ),
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='remark', path=f'$.remark', type='string', state='form', ui_kind='text', required=True, description='备注'),  # zh_ambiguous
