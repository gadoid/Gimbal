"""fin.logistics_user.customer_company_list —— 孪生生成器产物(请求面;行为面归场景用例)。
...
LOGISTICS_USER_CUSTOMER_COMPANY_LIST: Final[EndpointSpec] = EndpointSpec(
    id='fin.logistics_user.customer_company_list',
    system='fin',
    service='fin-service',
    name='LogisticsUser.customerCompanyList',
    description='LogisticsUser.customerCompanyList' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/operation/logisticsUser/customerCompanyList',
        headers={},
        consumes=[],
        produces=[],
    ),
