"""fin.estimate.estimate_page —— 孪生生成器产物(请求面;行为面归场景用例)。
...
ESTIMATE_ESTIMATE_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.estimate.estimate_page',
    system='fin',
    service='fin-service',
    name='Estimate.estimatePage',
    description='Estimate.estimatePage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/estimate/estimatePage',
        headers={},
        consumes=[],
        produces=[],
    ),
