"""fin.order_order.order_page —— 孪生生成器产物(请求面;行为面归场景用例)。
...
溯源统计: lang=31, column=26, frontend=20, 无zh=16, derived=13, builtin=4, frontend_label=4 | fe_high=28, enum=2
"""
...
ORDER_ORDER_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.order_order.order_page',
    system='fin',
    service='fin-service',
    name='Order.orderPage',
    description='Order.orderPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
