"""fin.order_order.change_invoice_apply —— 孪生生成器产物(请求面;行为面归场景用例)。
...
ORDER_CHANGE_INVOICE_APPLY: Final[EndpointSpec] = EndpointSpec(
    id='fin.order_order.change_invoice_apply',
    system='fin',
    service='fin-service',
    name='操作',
