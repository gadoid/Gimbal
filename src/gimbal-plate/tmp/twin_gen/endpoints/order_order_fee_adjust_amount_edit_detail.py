...
ORDER_FEE_ADJUST_AMOUNT_EDIT_DETAIL: Final[EndpointSpec] = EndpointSpec(
    id='fin.order_fee.adjust_amount_edit_detail',
    system='fin',
    service='fin-service',
    name='OrderFee.adjustAmountEditDetail',
    description='OrderFee.adjustAmountEditDetail' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/order/orderFee/adjustAmountEditDetail',
        headers={},
        consumes=[],
        produces=[],
    ),
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='retract_status', path=f'$.retract_status', type='string', state='form', ui_kind='text'),
