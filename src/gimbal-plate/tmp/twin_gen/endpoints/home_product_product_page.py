"""fin.product.product_page —— 孪生生成器产物(请求面;行为面归场景用例)。
...
PRODUCT_PRODUCT_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.product.product_page',
    system='fin',
    service='fin-service',
    name='Product.productPage',
    description='Product.productPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/home/product/productPage',
        headers={},
        consumes=[],
        produces=[],
    ),
