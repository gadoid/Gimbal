"""fin.order_fee.real_amount_list —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): order_id, page_no, page_size, sort_field, sort_order
溯源统计: builtin=4, rule=1, column=1 | fe_high=0, enum=1
"""
...
ORDER_FEE_REAL_AMOUNT_LIST: Final[EndpointSpec] = EndpointSpec(
    id='fin.order_fee.real_amount_list',
    system='fin',
    service='fin-service',
    name='OrderFee.realAmountList',
    description='OrderFee.realAmountList' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/order/orderFee/realAmountList',
        headers={},
        consumes=[],
        produces=[],
    ),
