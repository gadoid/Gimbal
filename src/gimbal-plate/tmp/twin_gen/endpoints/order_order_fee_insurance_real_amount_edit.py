...
ORDER_FEE_INSURANCE_REAL_AMOUNT_EDIT: Final[EndpointSpec] = EndpointSpec(
    id='fin.order_fee.insurance_real_amount_edit',
    system='fin',
    service='fin-service',
    name='操作',
    ...
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/order/orderFee/insuranceRealAmountEdit',
        headers={},
        consumes=[],
        produces=[],
    ),
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='import_status', path=f'$.import_status', type='string', state='form', ui_kind='text'),
            DeclarationEntry(name='to_customer', path=f'$.to_customer', type='string', state='form', ui_kind='text'),
            DeclarationEntry(name='to_customer_supplier', path=f'$.to_customer_supplier', type='string', state='form', ui_kind='text'),
            DeclarationEntry(name='to_supplier', path=f'$.to_supplier', type='string', state='form', ui_kind='text'),
            DeclarationEntry(name='to_cooperate', path=f'$.to_cooperate', type='string', state='form', ui_kind='text'),
