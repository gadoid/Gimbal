"""fin.receive_account.receive_account_page —— 孪生生成器产物(请求面;行为面归场景用例)。
...
RECEIVE_ACCOUNT_RECEIVE_ACCOUNT_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.receive_account.receive_account_page',
    system='fin',
    service='fin-service',
    name='ReceiveAccount.receiveAccountPage',
    description='ReceiveAccount.receiveAccountPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/receiveAccount/receiveAccountPage',
        headers={},
        consumes=[],
        produces=[],
    ),
