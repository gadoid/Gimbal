"""fin.order_entrust.order_detail —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): order_id, num, status, service_project
溯源统计: 无zh=25, lang=21, column=12, derived=9, header=1 | fe_high=0, enum=1
"""
...
ORDER_ENTRUST_ORDER_DETAIL: Final[EndpointSpec] = EndpointSpec(
    id='fin.order_entrust.order_detail',
    system='fin',
    service='fin-service',
    name='OrderEntrust.orderDetail',
    description='OrderEntrust.orderDetail' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/order/orderEntrust/orderDetail',
        headers={},
        consumes=[],
        produces=[],
    ),
