...
EXCHANGE_RATE_MONTH_EXCHANGE_RATE: Final[EndpointSpec] = EndpointSpec(
    ...
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='original_currency', path=f'$.original_currency', type='string', state='form', default='CNY', description='原始币别'),
            DeclarationEntry(name='target_currency', path=f'$.target_currency', type='string', state='form', default='USD', description='目标币别'),
        ],
    ),
    responses={
        200: ResponseSpec(
