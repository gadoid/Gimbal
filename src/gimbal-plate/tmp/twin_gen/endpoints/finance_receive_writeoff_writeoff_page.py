...
needs_capture(首跑经 gimbal 执行回填): receive_invoice_batch_no, create_time, link_audit_status, customer_id, main_id, currency, create_id, pay_settle_object_id, receive_writeoff_no, writeoff_status, pay_invoice_batch_no, receive_invoice_apply_no, cancel_status, put_settle_object_id, invoice_status, invoice_no, sort_field, sort_order
溯源统计: frontend=33, derived=6, column=5, builtin=4, lang=1, 无zh=1 | fe_high=34, enum=1
"""
