"""fin.logistics_user.supplier_company_list —— 孪生生成器产物(请求面;行为面归场景用例)。
...
LOGISTICS_USER_SUPPLIER_COMPANY_LIST: Final[EndpointSpec] = EndpointSpec(
    id='fin.logistics_user.supplier_company_list',
    system='fin',
    service='fin-service',
    name='LogisticsUser.supplierCompanyList',
    description='LogisticsUser.supplierCompanyList' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/operation/logisticsUser/supplierCompanyList',
        headers={},
        consumes=[],
        produces=[],
    ),
