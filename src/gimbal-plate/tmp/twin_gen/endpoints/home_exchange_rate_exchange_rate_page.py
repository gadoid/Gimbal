"""fin.exchange_rate.exchange_rate_page —— 孪生生成器产物(请求面;行为面归场景用例)。
...
EXCHANGE_RATE_EXCHANGE_RATE_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.exchange_rate.exchange_rate_page',
    system='fin',
    service='fin-service',
    name='ExchangeRate.exchangeRatePage',
    description='ExchangeRate.exchangeRatePage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/home/exchangeRate/exchangeRatePage',
        headers={},
        consumes=[],
        produces=[],
    ),
