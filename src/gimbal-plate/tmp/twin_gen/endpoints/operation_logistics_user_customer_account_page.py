"""fin.logistics_user.customer_account_page —— 孪生生成器产物(请求面;行为面归场景用例)。
...
LOGISTICS_USER_CUSTOMER_ACCOUNT_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.logistics_user.customer_account_page',
    system='fin',
    service='fin-service',
    name='LogisticsUser.customerAccountPage',
    description='LogisticsUser.customerAccountPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/operation/logisticsUser/customerAccountPage',
        headers={},
        consumes=[],
        produces=[],
    ),
