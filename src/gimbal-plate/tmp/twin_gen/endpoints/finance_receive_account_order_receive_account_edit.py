"""fin.receive_account.order_receive_account_edit —— 孪生生成器产物(请求面;行为面归场景用例)。
...
RECEIVE_ACCOUNT_ORDER_RECEIVE_ACCOUNT_EDIT: Final[EndpointSpec] = EndpointSpec(
    id='fin.receive_account.order_receive_account_edit',
    system='fin',
    service='fin-service',
    name='操作',
