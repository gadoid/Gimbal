"""fin.pay_account.pay_account_detail —— 孪生生成器产物(请求面;行为面归场景用例)。
...
PAY_ACCOUNT_PAY_ACCOUNT_DETAIL: Final[EndpointSpec] = EndpointSpec(
    id='fin.pay_account.pay_account_detail',
    system='fin',
    service='fin-service',
    name='操作',
    ...
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/payAccount/payAccountDetail',
        headers={},
        consumes=[],
        produces=[],
    ),
