"""fin.track.test_receive_track —— 孪生生成器产物(请求面;行为面归场景用例)。
...
TRACK_TEST_RECEIVE_TRACK: Final[EndpointSpec] = EndpointSpec(
    id='fin.track.test_receive_track',
    system='fin',
    service='fin-service',
    name='Track.testReceiveTrack',
    description='Track.testReceiveTrack' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/api/track/testReceiveTrack',
        headers={},
        consumes=[],
        produces=[],
    ),
