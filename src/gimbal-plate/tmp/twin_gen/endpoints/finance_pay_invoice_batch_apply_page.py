"""fin.pay_invoice_batch.apply_page —— 孪生生成器产物(请求面;行为面归场景用例)。
...
溯源统计: frontend=19, lang=5, 无zh=5, builtin=4, column=1 | fe_high=24, enum=1
"""
...
PAY_INVOICE_BATCH_APPLY_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.pay_invoice_batch.apply_page',
    system='fin',
    service='fin-service',
    name='PayInvoiceBatch.applyPage',
    description='PayInvoiceBatch.applyPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/payInvoiceBatch/applyPage',
        headers={},
        consumes=[],
        produces=[],
    ),
