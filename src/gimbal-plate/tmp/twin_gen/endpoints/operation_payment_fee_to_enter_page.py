"""fin.payment_fee.to_enter_page —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): payment_status, payment_method, sort_field, sort_order
...
PAYMENT_FEE_TO_ENTER_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.payment_fee.to_enter_page',
    system='fin',
    service='fin-service',
    name='PaymentFee.toEnterPage',
    description='PaymentFee.toEnterPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/operation/paymentFee/toEnterPage',
        headers={},
        consumes=[],
        produces=[],
    ),
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='enter_status', path=f'$.enter_status', type='integer', state='form', ui_kind='number', default='0', description='0待录入 1已录入'),
