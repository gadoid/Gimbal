"""fin.account_fee.sub_settle_list —— 孪生生成器产物(请求面;行为面归场景用例)。
...
ACCOUNT_FEE_SUB_SETTLE_LIST: Final[EndpointSpec] = EndpointSpec(
    id='fin.account_fee.sub_settle_list',
    system='fin',
    service='fin-service',
    name='AccountFee.subSettleList',
    description='AccountFee.subSettleList' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/accountFee/subSettleList',
        headers={},
        consumes=[],
        produces=[],
    ),
