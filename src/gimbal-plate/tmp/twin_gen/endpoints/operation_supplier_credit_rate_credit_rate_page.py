"""fin.supplier_credit_rate.credit_rate_page —— 孪生生成器产物(请求面;行为面归场景用例)。
...
SUPPLIER_CREDIT_RATE_CREDIT_RATE_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.supplier_credit_rate.credit_rate_page',
    system='fin',
    service='fin-service',
    name='SupplierCreditRate.creditRatePage',
    description='SupplierCreditRate.creditRatePage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/operation/supplierCreditRate/creditRatePage',
        headers={},
        consumes=[],
        produces=[],
    ),
