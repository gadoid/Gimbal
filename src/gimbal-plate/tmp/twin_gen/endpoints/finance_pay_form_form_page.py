"""fin.pay_form.form_page —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): create_time, customer_id, customer_main_id, main_id, pay_settle_object_id, currency, status, writeoff_status, create_id, pay_invoice_apply_no, pay_invoice_batch_no, cancel_status, link_audit_status, invoice_status, invoice_no, receive_invoice_apply_no, receive_invoice_batch_no, put_settle_object_id, sort_field
溯源统计: frontend=26, lang=6, derived=6, builtin=4, 无zh=4, column=2 | fe_high=31, enum=1
"""
...
PAY_FORM_FORM_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.pay_form.form_page',
    system='fin',
    service='fin-service',
    name='PayForm.formPage',
    description='PayForm.formPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/payForm/formPage',
        headers={},
        consumes=[],
        produces=[],
    ),
