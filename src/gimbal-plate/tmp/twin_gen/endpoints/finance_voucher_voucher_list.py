"""fin.finance_voucher.voucher_list —— 孪生生成器产物(请求面;行为面归场景用例)。
...
VOUCHER_VOUCHER_LIST: Final[EndpointSpec] = EndpointSpec(
    id='fin.finance_voucher.voucher_list',
    system='fin',
    service='fin-service',
    name='Voucher.voucherList',
    description='Voucher.voucherList' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/voucher/voucherList',
        headers={},
        consumes=[],
        produces=[],
    ),
