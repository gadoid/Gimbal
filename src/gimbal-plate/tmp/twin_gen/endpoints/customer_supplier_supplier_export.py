"""fin.supplier.supplier_export —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): (无)
溯源统计: builtin=2, 无zh=1, lang=1, column=1 | fe_high=0, enum=0
"""
...
SUPPLIER_SUPPLIER_EXPORT: Final[EndpointSpec] = EndpointSpec(
    id='fin.supplier.supplier_export',
    system='fin',
    service='fin-service',
    name='Supplier.supplierExport',
    description='Supplier.supplierExport' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/customer/supplier/supplierExport',
        headers={},
        consumes=[],
        produces=[],
    ),
