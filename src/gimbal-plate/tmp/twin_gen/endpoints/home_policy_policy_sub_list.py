"""fin.home_policy.policy_sub_list —— 孪生生成器产物(请求面;行为面归场景用例)。
...
POLICY_POLICY_SUB_LIST: Final[EndpointSpec] = EndpointSpec(
    id='fin.home_policy.policy_sub_list',
    system='fin',
    service='fin-service',
    name='Policy.policySubList',
    description='Policy.policySubList' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/home/policy/policySubList',
        headers={},
        consumes=[],
        produces=[],
    ),
