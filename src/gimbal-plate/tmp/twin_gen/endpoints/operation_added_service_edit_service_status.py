"""fin.added_service.edit_service_status —— 孪生生成器产物(请求面;行为面归场景用例)。
...
ADDED_SERVICE_EDIT_SERVICE_STATUS: Final[EndpointSpec] = EndpointSpec(
    id='fin.added_service.edit_service_status',
    system='fin',
    service='fin-service',
    name='AddedService.editServiceStatus',
    description='AddedService.editServiceStatus' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/operation/addedService/editServiceStatus',
        headers={},
        consumes=[],
        produces=[],
    ),
