"""fin.pay_invoice.invoice_add_check —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): invoice_number, invoice_type, invoice_amount, invoice_date, currency, invoice_exchange_rate, invoice_original, pay_settle_object, main_name, fee_main_name, sorce, replace_invoice_original, cancel_by, invoice_image_name
溯源统计: column=32, rule=13, 无zh=5 | fe_high=0, enum=2
"""
...
PAY_INVOICE_INVOICE_ADD_CHECK: Final[EndpointSpec] = EndpointSpec(
    id='fin.pay_invoice.invoice_add_check',
    system='fin',
    service='fin-service',
    name='PayInvoice.invoiceAddCheck',
    description='PayInvoice.invoiceAddCheck' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/payInvoice/invoiceAddCheck',
        headers={},
        consumes=[],
        produces=[],
    ),
