"""fin.finance_voucher.voucher_page —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): order_fee_real_id, sort_field, sort_order
溯源统计: builtin=4, column=2, 无zh=2 | fe_high=0, enum=1
"""
...
VOUCHER_VOUCHER_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.finance_voucher.voucher_page',
    system='fin',
    service='fin-service',
    name='Voucher.voucherPage',
    description='Voucher.voucherPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/voucher/voucherPage',
        headers={},
        consumes=[],
        produces=[],
    ),
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='order_fee_real_id', path=f'$.order_fee_real_id', type='integer', state='form', ui_kind='number', description='费用ID'),  # zh_ambiguous
