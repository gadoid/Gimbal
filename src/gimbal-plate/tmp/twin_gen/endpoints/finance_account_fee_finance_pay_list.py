"""fin.account_fee.finance_pay_list —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): customer_id, symbol, put_settle_object_id, pay_settle_object_id, main_id, currency, sort_field, sort_order
...
ACCOUNT_FEE_FINANCE_PAY_LIST: Final[EndpointSpec] = EndpointSpec(
    id='fin.account_fee.finance_pay_list',
    system='fin',
    service='fin-service',
    name='AccountFee.financePayList',
    description='AccountFee.financePayList' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/accountFee/financePayList',
        headers={},
        consumes=[],
        produces=[],
    ),
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='book_supplier_period', path=f'$.book_supplier_period', type='integer', state='form', ui_kind='number', description='订舱供应商账期'),
            DeclarationEntry(name='book_supplier_pay_date', path=f'$.book_supplier_pay_date', type='integer', state='form', ui_kind='number', description='订舱供应商应付日'),
