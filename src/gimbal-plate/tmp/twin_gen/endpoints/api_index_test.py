"""fin.index.test —— 孪生生成器产物(请求面;行为面归场景用例)。
...
INDEX_TEST: Final[EndpointSpec] = EndpointSpec(
    id='fin.index.test',
    system='fin',
    service='fin-service',
    name='Index.test',
    description='Index.test' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/api/index/test',
        headers={},
        consumes=[],
        produces=[],
    ),
