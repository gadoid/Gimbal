...
needs_capture(首跑经 gimbal 执行回填): status, role_id
溯源统计: column=2, 无zh=1 | fe_high=1, enum=0
"""
...
ROLE_ROLE_STATUS: Final[EndpointSpec] = EndpointSpec(
    ...
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='roleId', path=f'$.roleId', type='string', state='form', ui_kind='text'),
        ],
    ),
    responses={
        200: ResponseSpec(
