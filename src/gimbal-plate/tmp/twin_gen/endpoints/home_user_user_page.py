"""fin.user.user_page —— 孪生生成器产物(请求面;行为面归场景用例)。
...
USER_USER_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.user.user_page',
    system='fin',
    service='fin-service',
    name='User.userPage',
    description='User.userPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/home/user/userPage',
        headers={},
        consumes=[],
        produces=[],
    ),
