"""fin.logistics_company.supplier_page —— 孪生生成器产物(请求面;行为面归场景用例)。
...
LOGISTICS_COMPANY_SUPPLIER_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.logistics_company.supplier_page',
    system='fin',
    service='fin-service',
    name='LogisticsCompany.supplierPage',
    description='LogisticsCompany.supplierPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/operation/logisticsCompany/supplierPage',
        headers={},
        consumes=[],
        produces=[],
    ),
