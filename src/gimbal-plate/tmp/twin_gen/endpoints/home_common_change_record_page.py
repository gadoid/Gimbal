"""fin.home_common.change_record_page —— 孪生生成器产物(请求面;行为面归场景用例)。
...
COMMON_CHANGE_RECORD_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.home_common.change_record_page',
    system='fin',
    service='fin-service',
    name='Common.changeRecordPage',
    description='Common.changeRecordPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/home/common/changeRecordPage',
        headers={},
        consumes=[],
        produces=[],
    ),
