"""fin.dept.dept_del —— 孪生生成器产物(请求面;行为面归场景用例)。
...
DEPT_DEPT_DEL: Final[EndpointSpec] = EndpointSpec(
    id='fin.dept.dept_del',
    system='fin',
    service='fin-service',
    name='Dept.deptDel',
    description='Dept.deptDel' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/home/dept/deptDel',
        headers={},
        consumes=[],
        produces=[],
    ),
