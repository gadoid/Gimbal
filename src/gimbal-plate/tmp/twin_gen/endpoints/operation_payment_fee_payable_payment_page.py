"""fin.payment_fee.payable_payment_page —— 孪生生成器产物(请求面;行为面归场景用例)。
...
PAYMENT_FEE_PAYABLE_PAYMENT_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.payment_fee.payable_payment_page',
    system='fin',
    service='fin-service',
    name='PaymentFee.payablePaymentPage',
    description='PaymentFee.payablePaymentPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/operation/paymentFee/payablePaymentPage',
        headers={},
        consumes=[],
        produces=[],
    ),
