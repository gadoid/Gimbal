"""fin.logistics_order.order_page —— 孪生生成器产物(请求面;行为面归场景用例)。
...
LOGISTICS_ORDER_ORDER_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.logistics_order.order_page',
    system='fin',
    service='fin-service',
    name='LogisticsOrder.orderPage',
    description='LogisticsOrder.orderPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/operation/logisticsOrder/orderPage',
        headers={},
        consumes=[],
        produces=[],
    ),
