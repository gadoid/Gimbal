...
ORDER_FEE_REAL_AMOUNT_SUBMIT: Final[EndpointSpec] = EndpointSpec(
    ...
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='box_no_continue', path=f'$.box_no_continue', type='string', state='form'),
            DeclarationEntry(name='check_self_fee_status', path=f'$.check_self_fee_status', type='string', state='form'),
            ...
            DeclarationEntry(name='main_ids', path=f'$.main_ids', type='string', state='form', description='主体顺序ID'),
