"""fin.order_order.order_edit —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): order_id, customer_contact_name, operator_name, service_items, business_type, carrier, pol, pot, pod, del, terms_payment, terms_transport, pay_type, customer_order_sn, cargo_type, num, gross_weight, packer, terms_shipment, remark, country_name, ocean_type, ship_mark, commodity, notes, status, customer_id, main_sort, track_bl_no, order_self_id, customer_address_cn, customer_contact_phone, pol_cn, pol_country, pol_country_cn, pod_cn, pot_cn, del_cn, discount_rule, discount_ratio, discount_currency, fee_miss_name, effective_by, audit_type, customer_put_date_desc
溯源统计: column=140, rule=35, lang=27, 无zh=9, derived=2, header=1 | fe_high=74, enum=1
"""
...
ORDER_ORDER_EDIT: Final[EndpointSpec] = EndpointSpec(
    id='fin.order_order.order_edit',
    system='fin',
    service='fin-service',
    name='操作',
    ...
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/order/order/orderEdit',
        headers={},
        consumes=[],
        produces=[],
    ),
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='customer_name', path=f'$.customer_name', type='string', state='carry', ui_kind='text', description='客户名字', value_source=ValueSource(view='customer_list', column='customer_name'), source_kind='lookup'),
            ...
            DeclarationEntry(name='operator_name', path=f'$.operator_name', type='string', state='carry', ui_kind='text', description='操作名字'),  # needs_capture:value_source
            ...
            DeclarationEntry(name='container', path=f'$.container', type='array', state='form', ui_kind='unknown', description='集装箱信息',
                children=[
            ...
            DeclarationEntry(name='service_id', path=f'$.service_id', type='integer', state='carry', ui_kind='number', default='0', description='客服'),
            DeclarationEntry(name='sale_id', path=f'$.sale_id', type='integer', state='carry', ui_kind='number', default='0', description='销售'),
            DeclarationEntry(name='operator_id', path=f'$.operator_id', type='integer', state='form', ui_kind='number', default='0', description='操作人'),
            DeclarationEntry(name='customer_contact_id', path=f'$.customer_contact_id', type='integer', state='carry', ui_kind='number', default='0', description='联系人'),
            ...
            DeclarationEntry(name='track_bl_no', path=f'$.track_bl_no', type='string', state='carry', ui_kind='text', description='运踪提单号'),  # zh_ambiguous
