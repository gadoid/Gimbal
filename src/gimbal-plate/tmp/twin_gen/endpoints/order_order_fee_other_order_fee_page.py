...
ORDER_FEE_OTHER_ORDER_FEE_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.order_fee.other_order_fee_page',
    system='fin',
    service='fin-service',
    name='OrderFee.otherOrderFeePage',
    description='OrderFee.otherOrderFeePage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/order/orderFee/otherOrderFeePage',
        headers={},
        consumes=[],
        produces=[],
    ),
