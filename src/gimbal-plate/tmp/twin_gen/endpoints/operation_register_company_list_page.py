"""fin.register_company.list_page —— 孪生生成器产物(请求面;行为面归场景用例)。
...
REGISTER_COMPANY_LIST_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.register_company.list_page',
    system='fin',
    service='fin-service',
    name='RegisterCompany.listPage',
    description='RegisterCompany.listPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/operation/registerCompany/listPage',
        headers={},
        consumes=[],
        produces=[],
    ),
