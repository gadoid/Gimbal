"""fin.relate.check_logic —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): customer_id, supplier_id, settle_type
溯源统计: column=3, 无zh=3, lang=1 | fe_high=0, enum=0
"""
...
RELATE_CHECK_LOGIC: Final[EndpointSpec] = EndpointSpec(
    id='fin.relate.check_logic',
    system='fin',
    service='fin-service',
    name='Relate.checkLogic',
    description='Relate.checkLogic' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/customer/relate/checkLogic',
        headers={},
        consumes=[],
        produces=[],
    ),
