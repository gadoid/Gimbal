"""fin.receive_writeoff.writeoff_order_page —— 孪生生成器产物(请求面;行为面归场景用例)。
...
RECEIVE_WRITEOFF_WRITEOFF_ORDER_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.receive_writeoff.writeoff_order_page',
    system='fin',
    service='fin-service',
    name='ReceiveWriteoff.writeoffOrderPage',
    description='ReceiveWriteoff.writeoffOrderPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/receiveWriteoff/writeoffOrderPage',
        headers={},
        consumes=[],
        produces=[],
    ),
