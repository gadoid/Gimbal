"""fin.order_order.order_book —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): customer_id, policy_type, main_sort, service_items, track_bl_no, remark, num, pot, country_name, terms_payment, terms_transport, pay_type, customer_order_sn, packer, volume_desc, status, customer_contact_name, airline_type, ocean_type, order_id, allocation_no, policy_no, create_id, create_time, update_time, order_self_id, customer_address_cn, customer_contact_phone, pol_cn, pol_country, pol_country_cn, pod_cn, pot_cn, del_cn, discount_rule, discount_ratio, discount_currency, fee_miss_name, effective_by, audit_type, customer_put_date_desc
溯源统计: column=128, rule=45, lang=24, frontend=9, 无zh=8, derived=2, header=1 | fe_high=93, enum=0
"""
...
ORDER_ORDER_BOOK: Final[EndpointSpec] = EndpointSpec(
    id='fin.order_order.order_book',
    system='fin',
    service='fin-service',
    name='Order.orderBook',
    description='Order.orderBook' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
    ...
    request=RequestSpec(
        body_type='json',
        declarations=[
            DeclarationEntry(name='customer_id', path=f'$.customer_id', type='integer', state='form', ui_kind='number', required=True, default='0', description='客户ID'),  # zh_ambiguous
            DeclarationEntry(name='customer_contact_id', path=f'$.customer_contact_id', type='integer', state='form', ui_kind='number', default='0', description='客户联系人id'),
            DeclarationEntry(name='operator_id', path=f'$.operator_id', type='integer', state='form', ui_kind='number', default='0', description='操作ID'),
            DeclarationEntry(name='policy_type', path=f'$.policy_type', type='string', state='carry', ui_kind='text', description='政策类型'),  # needs_capture:value_source
            DeclarationEntry(name='policy_id', path=f'$.policy_id', type='integer', state='form', ui_kind='number', description='服务策略ID'),
            DeclarationEntry(name='policy_name', path=f'$.policy_name', type='string', state='carry', ui_kind='text', description='服务策略名字', value_source=ValueSource(view='customer_policy', column='policy_name'), source_kind='lookup'),
            ...
            DeclarationEntry(name='service_items', path=f'$.service_items', type='string', state='carry', ui_kind='text', description='服务项目'),  # needs_capture:value_source
            DeclarationEntry(name='bl_no', path=f'$.bl_no', type='string', state='form', ui_kind='text', description='提单号'),
            DeclarationEntry(name='track_bl_no', path=f'$.track_bl_no', type='string', state='carry', ui_kind='text', description='提单号'),  # zh_ambiguous, needs_capture:value_source
            DeclarationEntry(name='remark', path=f'$.remark', type='string', state='carry', ui_kind='text', description='备注'),  # needs_capture:value_source
            DeclarationEntry(name='num', path=f'$.num', type='integer', state='form', ui_kind='number', description='件数'),  # zh_ambiguous
            DeclarationEntry(name='service_id', path=f'$.service_id', type='integer', state='carry', ui_kind='number', default='0', description='客服ID'),
            DeclarationEntry(name='sale_id', path=f'$.sale_id', type='integer', state='form', ui_kind='number', default='0', description='销售ID'),
            DeclarationEntry(name='settle_type', path=f'$.settle_type', type='integer', state='carry', ui_kind='number', default='0', description='结算方式'),
            ...
            DeclarationEntry(name='carrier', path=f'$.carrier', type='string', state='carry', ui_kind='text', description='船公司/承运人'),
            ...
            DeclarationEntry(name='country_name', path=f'$.country_name', type='string', state='carry', ui_kind='text', description='卸货港国家'),  # needs_capture:value_source
            ...
            DeclarationEntry(name='gross_weight', path=f'$.gross_weight', type='number', state='form', ui_kind='number', description='毛重'),
            DeclarationEntry(name='bulk', path=f'$.bulk', type='number', state='form', ui_kind='number', description='体积'),
            ...
            DeclarationEntry(name='container', path=f'$.container', type='string', state='form', ui_kind='text', description='箱型'),
            ...
            DeclarationEntry(name='shipper', path=f'$.shipper', type='string', state='form', ui_kind='text', description='发货人'),
            DeclarationEntry(name='consignee', path=f'$.consignee', type='string', state='form', ui_kind='text', description='收货人'),
            DeclarationEntry(name='notifier', path=f'$.notifier', type='string', state='form', ui_kind='text', description='通知人'),
            DeclarationEntry(name='ship_mark', path=f'$.ship_mark', type='string', state='form', ui_kind='text', description='唛头'),
            DeclarationEntry(name='commodity', path=f'$.commodity', type='string', state='form', ui_kind='textarea', description='品名'),
            DeclarationEntry(name='notes', path=f'$.notes', type='string', state='form', ui_kind='text', description='托书备注'),
            DeclarationEntry(name='terms_shipment', path=f'$.terms_shipment', type='string', state='form', ui_kind='text', description='装运条款'),
            DeclarationEntry(name='is_usd_project', path=f'$.is_usd_project', type='integer', state='carry', ui_kind='number', default='2', description='是否USD项目'),
            ...
            DeclarationEntry(name='service_name', path=f'$.service_name', type='string', state='carry', ui_kind='text', description='客服'),
            DeclarationEntry(name='sale_name', path=f'$.sale_name', type='string', state='carry', ui_kind='text', description='销售'),
            DeclarationEntry(name='operator_name', path=f'$.operator_name', type='string', state='carry', ui_kind='text', description='操作人'),
            DeclarationEntry(name='customer_contact_name', path=f'$.customer_contact_name', type='string', state='carry', ui_kind='text', description='联系人'),  # needs_capture:value_source
            DeclarationEntry(name='settle_type_name', path=f'$.settle_type_name', type='string', state='carry', ui_kind='text', description='结算方式名称'),
            DeclarationEntry(name='customer_product_id', path=f'$.customer_product_id', type='string', state='carry', ui_kind='text'),
            DeclarationEntry(name='product_name', path=f'$.product_name', type='string', state='carry', ui_kind='text', description='客户产品名称'),
            DeclarationEntry(name='deposit_type', path=f'$.deposit_type', type='integer', state='carry', ui_kind='number', default='0', description='保证金类型  1有 2无'),
            DeclarationEntry(name='deposit_type_name', path=f'$.deposit_type_name', type='string', state='carry', ui_kind='text'),
            DeclarationEntry(name='period_delay_type', path=f'$.period_delay_type', type='integer', state='carry', ui_kind='number', default='0', description='客户账期类型'),
            DeclarationEntry(name='period_delay_type_name', path=f'$.period_delay_type_name', type='string', state='carry', ui_kind='text', description='客户账期类型名称'),
            DeclarationEntry(name='carrier_id', path=f'$.carrier_id', type='integer', state='carry', ui_kind='number', default='0', description='船公司  / 承运人ID'),
            ...
            DeclarationEntry(name='sea_trans_cost', path=f'$.sea_trans_cost', type='number', state='form', ui_kind='number', default='0.00', description='结算海运费'),
            DeclarationEntry(name='teu', path=f'$.teu', type='string', state='carry', ui_kind='text', description='折TEU'),
            DeclarationEntry(name='order_sn', path=f'$.order_sn', type='string', state='carry', ui_kind='text'),
            DeclarationEntry(name='sea_trans_currency', path=f'$.sea_trans_currency', type='string', state='form', ui_kind='text', description='海运费币制'),
            DeclarationEntry(name='message_board', path=f'$.message_board', type='string', state='carry', ui_kind='text'),
            DeclarationEntry(name='customer_file_list', path=f'$.customer_file_list', type='string', state='carry', ui_kind='file'),
            DeclarationEntry(name='order_id', path=f'$.order_id', type='integer', state='carry', ui_kind='number', default='0', description='订单ID'),  # zh_ambiguous
            ...
            DeclarationEntry(name='book_user_id', path=f'$.book_user_id', type='string', state='carry', ui_kind='text', description='订舱供应商服务人员'),
            DeclarationEntry(name='bill_supplier_id', path=f'$.bill_supplier_id', type='string', state='carry', ui_kind='text', description='报关供应商'),
            DeclarationEntry(name='bill_user_id', path=f'$.bill_user_id', type='string', state='carry', ui_kind='text', description='报关供应商服务人员'),
            DeclarationEntry(name='manifest_supplier_id', path=f'$.manifest_supplier_id', type='integer', state='carry', ui_kind='number', default='0', description='舱单供应商'),
            DeclarationEntry(name='manifest_user_id', path=f'$.manifest_user_id', type='string', state='carry', ui_kind='text', description='舱单供应商服务人员'),
            DeclarationEntry(name='insurance_supplier_id', path=f'$.insurance_supplier_id', type='integer', state='carry', ui_kind='number', default='0', description='保险供应商'),
            DeclarationEntry(name='insurance_user_id', path=f'$.insurance_user_id', type='string', state='carry', ui_kind='text', description='保险供应商服务人员'),
            DeclarationEntry(name='product_id', path=f'$.product_id', type='integer', state='carry', ui_kind='number', default='0', description='客户产品ID'),
            DeclarationEntry(name='client_expand_id', path=f'$.client_expand_id', type='integer', state='carry', ui_kind='number', default='0', description='直客拓展'),
            ...
            DeclarationEntry(name='allocation_no', path=f'$.allocation_no', type='string', state='carry', ui_kind='text', description='分配明细ID'),  # needs_capture:value_source
            DeclarationEntry(name='customer_no', path=f'$.customer_no', type='string', state='carry', ui_kind='text', description='客户ID'),
            DeclarationEntry(name='customer_tax_number', path=f'$.customer_tax_number', type='string', state='carry', ui_kind='text', description='统一社会信用代码'),
            DeclarationEntry(name='policy_no', path=f'$.policy_no', type='string', state='carry', ui_kind='text', description='服务策略ID'),  # needs_capture:value_source
            ...
            DeclarationEntry(name='order_self_id', path=f'$.order_self_id', type='integer', state='carry', ui_kind='number', default='0', description='订单id'),  # zh_ambiguous
            DeclarationEntry(name='self_status', path=f'$.self_status', type='string', state='carry', ui_kind='text'),
            ...
            DeclarationEntry(name='book_supplier_name', path=f'$.book_supplier_name', type='string', state='form', ui_kind='text', description='订舱供应商'),
