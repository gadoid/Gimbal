"""fin.receive_writeoff.writeoff_conn_invoice_list —— 孪生生成器产物(请求面;行为面归场景用例)。
...
RECEIVE_WRITEOFF_WRITEOFF_CONN_INVOICE_LIST: Final[EndpointSpec] = EndpointSpec(
    id='fin.receive_writeoff.writeoff_conn_invoice_list',
    system='fin',
    service='fin-service',
    name='ReceiveWriteoff.writeoffConnInvoiceList',
    description='ReceiveWriteoff.writeoffConnInvoiceList' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/receiveWriteoff/writeoffConnInvoiceList',
        headers={},
        consumes=[],
        produces=[],
    ),
