...
PORT_PORT_LIST: Final[EndpointSpec] = EndpointSpec(
    ...
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='port_id', path=f'$.port_id', type='integer', state='form', ui_kind='number'),
            DeclarationEntry(name='cn_name', path=f'$.cn_name', type='string', state='form', ui_kind='text', description='国家中文名'),
