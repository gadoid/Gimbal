"""fin.order_order.batch_policy_type_list —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): page_no, page_size, sort_field, sort_order
溯源统计: builtin=4, derived=1, lang=1 | fe_high=0, enum=1
"""
...
ORDER_BATCH_POLICY_TYPE_LIST: Final[EndpointSpec] = EndpointSpec(
    id='fin.order_order.batch_policy_type_list',
    system='fin',
    service='fin-service',
    name='Order.batchPolicyTypeList',
    description='Order.batchPolicyTypeList' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/order/order/batchPolicyTypeList',
        headers={},
        consumes=[],
        produces=[],
    ),
