...
溯源统计: column=3, rule=1 | fe_high=0, enum=1
"""
...
RECEIVE_WRITEOFF_CONFIRM_RECEIVE_WRITEOFF: Final[EndpointSpec] = EndpointSpec(
    ...
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='statement', path=f'$.statement', type='string', state='form', ui_kind='text', required=True, description='核销流水'),
