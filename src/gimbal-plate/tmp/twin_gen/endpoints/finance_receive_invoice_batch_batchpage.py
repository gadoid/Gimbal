"""fin.receive_invoice_batch.batchpage —— 孪生生成器产物(请求面;行为面归场景用例)。
...
溯源统计: frontend=19, lang=5, builtin=4, 无zh=1, column=1 | fe_high=24, enum=1
"""
...
RECEIVE_INVOICE_BATCH_BATCHPAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.receive_invoice_batch.batchpage',
    system='fin',
    service='fin-service',
    name='ReceiveInvoiceBatch.batchpage',
    description='ReceiveInvoiceBatch.batchpage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/receiveInvoiceBatch/batchpage',
        headers={},
        consumes=[],
        produces=[],
    ),
