"""fin.order_order.order_export —— 孪生生成器产物(请求面;行为面归场景用例)。
...
溯源统计: lang=31, column=26, frontend=20, 无zh=16, derived=13, frontend_label=4 | fe_high=28, enum=1
"""
...
ORDER_ORDER_EXPORT: Final[EndpointSpec] = EndpointSpec(
    id='fin.order_order.order_export',
    system='fin',
    service='fin-service',
    ...
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='revoke_reason', path=f'$.revoke_reason', type='string', state='form', ui_kind='text'),
