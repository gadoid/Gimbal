"""fin.order_entrust.order_cancel —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): order_id, flow_type
溯源统计: lang=2, column=2, 无zh=2, derived=1 | fe_high=0, enum=1
"""
...
ORDER_ENTRUST_ORDER_CANCEL: Final[EndpointSpec] = EndpointSpec(
    id='fin.order_entrust.order_cancel',
    system='fin',
    service='fin-service',
    name='操作',
    ...
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/order/orderEntrust/orderCancel',
        headers={},
        consumes=[],
        produces=[],
    ),
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='cancel_remark', path=f'$.cancel_remark', type='string', state='form', ui_kind='text', required=True, description='作废原因'),
