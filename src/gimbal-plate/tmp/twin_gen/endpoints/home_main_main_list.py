"""fin.main.main_list —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): main_id, page_no, page_size, sort_field, sort_order
溯源统计: builtin=4, column=1 | fe_high=1, enum=1
"""
...
MAIN_MAIN_LIST: Final[EndpointSpec] = EndpointSpec(
    id='fin.main.main_list',
    system='fin',
    service='fin-service',
    name='Main.mainList',
    description='Main.mainList' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/home/main/mainList',
        headers={},
        consumes=[],
        produces=[],
    ),
    request=RequestSpec(
        body_type='json',
        declarations=[
            DeclarationEntry(name='main_id', path=f'$.main_id', type='integer', state='carry', ui_kind='number', default='0', description='费用主体ID'),  # zh_ambiguous
