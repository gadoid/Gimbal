"""fin.pay_demand.demand_edit_by_order —— 孪生生成器产物(请求面;行为面归场景用例)。
...
PAY_DEMAND_DEMAND_EDIT_BY_ORDER: Final[EndpointSpec] = EndpointSpec(
    id='fin.pay_demand.demand_edit_by_order',
    system='fin',
    service='fin-service',
    name='操作目的',
    ...
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/payDemand/demandEditByOrder',
        headers={},
        consumes=[],
        produces=[],
    ),
