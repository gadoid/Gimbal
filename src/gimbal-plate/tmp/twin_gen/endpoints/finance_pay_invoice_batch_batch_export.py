"""fin.pay_invoice_batch.batch_export —— 孪生生成器产物(请求面;行为面归场景用例)。
...
PAY_INVOICE_BATCH_BATCH_EXPORT: Final[EndpointSpec] = EndpointSpec(
    id='fin.pay_invoice_batch.batch_export',
    system='fin',
    service='fin-service',
    name='PayInvoiceBatch.batchExport',
    description='PayInvoiceBatch.batchExport' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/payInvoiceBatch/batchExport',
        headers={},
        consumes=[],
        produces=[],
    ),
