"""fin.main.main_page —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): main_id, sort_field, sort_order
...
MAIN_MAIN_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.main.main_page',
    system='fin',
    service='fin-service',
    name='Main.mainPage',
    description='Main.mainPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/home/main/mainPage',
        headers={},
        consumes=[],
        produces=[],
    ),
