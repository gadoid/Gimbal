...
needs_capture(首跑经 gimbal 执行回填): order_id, customer_contact_name, operator_name, service_items, remark, pot, del, terms_payment, terms_transport, pay_type, customer_order_sn, num, packer, shipper, consignee, notifier, terms_shipment, customer_id, main_sort, country_name, ocean_type, ship_mark, commodity, notes, status, track_bl_no, order_self_id, customer_address_cn, customer_contact_phone, pol_cn, pol_country, pol_country_cn, pod_cn, pot_cn, del_cn, discount_rule, discount_ratio, discount_currency, fee_miss_name, effective_by, audit_type, customer_put_date_desc
溯源统计: column=137, rule=35, lang=30, 无zh=10, derived=2, header=1 | fe_high=84, enum=1
"""
...
ORDER_ENTRUST_ORDER_EDIT: Final[EndpointSpec] = EndpointSpec(
    ...
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='etd', path=f'$.etd', type='integer', state='carry', ui_kind='number', default='0', description='预计开航日'),
            ...
            DeclarationEntry(name='num', path=f'$.num', type='integer', state='carry', ui_kind='number', description='件数'),  # zh_ambiguous
            ...
            DeclarationEntry(name='oldSupplierMap', path=f'$.oldSupplierMap', type='string', state='form', ui_kind='text'),
            DeclarationEntry(name='order_file', path=f'$.order_file', type='string', state='form', ui_kind='file'),
