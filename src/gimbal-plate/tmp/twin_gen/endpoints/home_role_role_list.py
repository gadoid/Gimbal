...
ROLE_ROLE_LIST: Final[EndpointSpec] = EndpointSpec(
    id='fin.role.role_list',
    system='fin',
    service='fin-service',
    name='Role.roleList',
    description='Role.roleList' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/home/role/roleList',
        headers={},
        consumes=[],
        produces=[],
    ),
