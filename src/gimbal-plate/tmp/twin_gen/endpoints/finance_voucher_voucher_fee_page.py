"""fin.finance_voucher.voucher_fee_page —— 孪生生成器产物(请求面;行为面归场景用例)。
...
VOUCHER_VOUCHER_FEE_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.finance_voucher.voucher_fee_page',
    system='fin',
    service='fin-service',
    name='Voucher.voucherFeePage',
    description='Voucher.voucherFeePage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/voucher/voucherFeePage',
        headers={},
        consumes=[],
        produces=[],
    ),
