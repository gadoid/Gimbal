"""fin.pay_invoice_batch.get_apply_company_obj_list —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): pay_invoice_apply_id, page_no, page_size, sort_field, sort_order
...
PAY_INVOICE_BATCH_GET_APPLY_COMPANY_OBJ_LIST: Final[EndpointSpec] = EndpointSpec(
    id='fin.pay_invoice_batch.get_apply_company_obj_list',
    system='fin',
    service='fin-service',
    name='PayInvoiceBatch.getApplyCompanyObjList',
    description='PayInvoiceBatch.getApplyCompanyObjList' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/payInvoiceBatch/getApplyCompanyObjList',
        headers={},
        consumes=[],
        produces=[],
    ),
