"""fin.production_finance.sync_user_account_status —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): dlgt_mobile_no, status
...
PRODUCTION_FINANCE_SYNC_USER_ACCOUNT_STATUS: Final[EndpointSpec] = EndpointSpec(
    id='fin.production_finance.sync_user_account_status',
    system='fin',
    service='fin-service',
    name='ProductionFinance.syncUserAccountStatus',
    description='ProductionFinance.syncUserAccountStatus' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/operation/productionFinance/syncUserAccountStatus',
        headers={},
        consumes=[],
        produces=[],
    ),
