"""fin.order_order.other_order_page —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): customer_id, order_no, status, service_project, customer_put_date, create_time, currency, fee_type, fund_code, create_id, invoice_number, track_bl_no, pay_status, fee_lock_status, discount_status, sort_field, sort_order
溯源统计: lang=33, column=28, frontend=20, 无zh=17, derived=13, builtin=4, frontend_label=3 | fe_high=28, enum=2
"""
...
ORDER_OTHER_ORDER_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.order_order.other_order_page',
    system='fin',
    service='fin-service',
    name='Order.otherOrderPage',
    description='Order.otherOrderPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/order/order/otherOrderPage',
        headers={},
        consumes=[],
        produces=[],
    ),
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='order_module', path=f'$.order_module', type='string', state='form', ui_kind='select', description='模块名称'),
            ...
            DeclarationEntry(name='order_nos', path=f'$.order_nos', type='string', state='form', ui_kind='text'),
            ...
            DeclarationEntry(name='customer_order_sn', path=f'$.customer_order_sn', type='string', state='form', ui_kind='text', description='客户单号'),
            DeclarationEntry(name='track_bl_no', path=f'$.track_bl_no', type='string', state='form', ui_kind='text', description='运踪提单号'),  # zh_ambiguous
            DeclarationEntry(name='track_bl_nos', path=f'$.track_bl_nos', type='string', state='form', ui_kind='text'),
            ...
            DeclarationEntry(name='pay_status', path=f'$.pay_status', type='integer', state='form', ui_kind='number', default='1', description='放款状态  1未放款 2已放款 3部分放款 '),  # zh_ambiguous
            DeclarationEntry(name='expect_fee_status', path=f'$.expect_fee_status', type='integer', state='form', ui_kind='number', default='0', description='实际费用状态  0创建中  1 审核中  2已锁定  3审核驳回 4撤销 5作废'),
            ...
            DeclarationEntry(name='fee_lock_status', path=f'$.fee_lock_status', type='integer', state='form', ui_kind='number', default='0', description='费用状态(锁定状态) 0创建中 1 部分锁定 2全部锁定'),  # zh_ambiguous
            DeclarationEntry(name='is_loan_before_invoice', path=f'$.is_loan_before_invoice', type='integer', state='form', ui_kind='number', default='0', description='未放款开票申请  0未申请   1已申请  2申请中'),
            ...
            DeclarationEntry(name='client_expand_id', path=f'$.client_expand_id', type='integer', state='form', ui_kind='number', default='0', description='直客拓展'),
            ...
            DeclarationEntry(name='track_atd_start', path=f'$.track_atd_start', type='string', state='form', ui_kind='text'),
            DeclarationEntry(name='track_atd_end', path=f'$.track_atd_end', type='string', state='form', ui_kind='text'),
            ...
            DeclarationEntry(name='customs_supplier_id', path=f'$.customs_supplier_id', type='string', state='form', ui_kind='text'),
            DeclarationEntry(name='customs_supplier_period', path=f'$.customs_supplier_period', type='string', state='form', ui_kind='text'),
            DeclarationEntry(name='customs_supplier_pay_date_start', path=f'$.customs_supplier_pay_date_start', type='string', state='form', ui_kind='text'),
            DeclarationEntry(name='customs_supplier_pay_date_end', path=f'$.customs_supplier_pay_date_end', type='string', state='form', ui_kind='text'),
            DeclarationEntry(name='manifest_supplier_id', path=f'$.manifest_supplier_id', type='integer', state='form', ui_kind='number', default='0', description='舱单供应商'),
            DeclarationEntry(name='manifest_supplier_period', path=f'$.manifest_supplier_period', type='string', state='form', ui_kind='text', description='舱单供应商账期（单位：天）'),
            DeclarationEntry(name='manifest_supplier_pay_date_start', path=f'$.manifest_supplier_pay_date_start', type='string', state='form', ui_kind='text'),
            DeclarationEntry(name='manifest_supplier_pay_date_end', path=f'$.manifest_supplier_pay_date_end', type='string', state='form', ui_kind='text'),
            DeclarationEntry(name='insurance_supplier_id', path=f'$.insurance_supplier_id', type='integer', state='form', ui_kind='number', default='0', description='保险供应商'),
            DeclarationEntry(name='insurance_supplier_period', path=f'$.insurance_supplier_period', type='string', state='form', ui_kind='text', description='保险供应商账期（单位：天）'),
            DeclarationEntry(name='insurance_supplier_pay_date_start', path=f'$.insurance_supplier_pay_date_start', type='string', state='form', ui_kind='text'),
            DeclarationEntry(name='insurance_supplier_pay_date_end', path=f'$.insurance_supplier_pay_date_end', type='string', state='form', ui_kind='text'),
            DeclarationEntry(name='trucking_supplier_id', path=f'$.trucking_supplier_id', type='string', state='form', ui_kind='text'),
            DeclarationEntry(name='trucking_supplier_period', path=f'$.trucking_supplier_period', type='string', state='form', ui_kind='text', description='拖车供应商账期（单位：天）'),
            DeclarationEntry(name='trucking_supplier_pay_date_start', path=f'$.trucking_supplier_pay_date_start', type='string', state='form', ui_kind='text'),
            DeclarationEntry(name='trucking_supplier_pay_date_end', path=f'$.trucking_supplier_pay_date_end', type='string', state='form', ui_kind='text'),
            ...
            DeclarationEntry(name='sale_id', path=f'$.sale_id', type='integer', state='form', ui_kind='number', default='0', description='销售'),
            ...
            DeclarationEntry(name='customer_account_status', path=f'$.customer_account_status', type='integer', state='form', ui_kind='number', description='对客应收对账状态'),
            DeclarationEntry(name='customer_invoice_status', path=f'$.customer_invoice_status', type='integer', state='form', ui_kind='number', description='对客应收开票状态'),
            DeclarationEntry(name='customer_writeoff_status', path=f'$.customer_writeoff_status', type='integer', state='form', ui_kind='number', description='对客应收核销状态'),
            DeclarationEntry(name='supplier_account_status', path=f'$.supplier_account_status', type='integer', state='form', ui_kind='number', description='对商应付对账状态'),
            DeclarationEntry(name='supplier_invoice_status', path=f'$.supplier_invoice_status', type='integer', state='form', ui_kind='number', description='对商应付开票状态'),
            DeclarationEntry(name='supplier_writeoff_status', path=f'$.supplier_writeoff_status', type='integer', state='form', ui_kind='number', description='对商应付核销状态'),
            DeclarationEntry(name='real_put_discount_rate', path=f'$.real_put_discount_rate', type='number', state='form', ui_kind='number', default='0.00', description='应收折扣比例'),
            ...
            DeclarationEntry(name='period_cutover_rule', path=f'$.period_cutover_rule', type='string', state='form', ui_kind='text'),
            DeclarationEntry(name='is_special_pay', path=f'$.is_special_pay', type='integer', state='form', ui_kind='number', default='0', description='供应商垫付申请 0 未申请 1 已申请 2申请中'),
            ...
            DeclarationEntry(name='term_rule_name', path=f'$.term_rule_name', type='string', state='form', ui_kind='text', description='账期规则名称'),
            DeclarationEntry(name='audit_type', path=f'$.audit_type', type='string', state='form', ui_kind='text', description='在途审批类型'),
            DeclarationEntry(name='is_financing', path=f'$.is_financing', type='integer', state='form', ui_kind='number', default='0', description='是否进入融资流程'),
            DeclarationEntry(name='customer_payment_type', path=f'$.customer_payment_type', type='string', state='form', ui_kind='text'),
            DeclarationEntry(name='product_name', path=f'$.product_name', type='string', state='form', ui_kind='text', description='客户产品名称'),
