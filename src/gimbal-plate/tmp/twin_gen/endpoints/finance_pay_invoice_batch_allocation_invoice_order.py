"""fin.pay_invoice_batch.allocation_invoice_order —— 孪生生成器产物(请求面;行为面归场景用例)。
...
PAY_INVOICE_BATCH_ALLOCATION_INVOICE_ORDER: Final[EndpointSpec] = EndpointSpec(
    id='fin.pay_invoice_batch.allocation_invoice_order',
    system='fin',
    service='fin-service',
    name='操作',
    ...
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/payInvoiceBatch/allocationInvoiceOrder',
        headers={},
        consumes=[],
        produces=[],
    ),
