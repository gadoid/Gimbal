"""fin.order_fee_dashboard.fee_summary_page —— 孪生生成器产物(请求面;行为面归场景用例)。
...
ORDER_FEE_DASHBOARD_FEE_SUMMARY_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.order_fee_dashboard.fee_summary_page',
    system='fin',
    service='fin-service',
    name='OrderFeeDashboard.feeSummaryPage',
    description='OrderFeeDashboard.feeSummaryPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/order/orderFeeDashboard/feeSummaryPage',
        headers={},
        consumes=[],
        produces=[],
    ),
