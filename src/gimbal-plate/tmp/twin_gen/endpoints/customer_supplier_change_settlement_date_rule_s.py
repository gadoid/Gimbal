...
needs_capture(首跑经 gimbal 执行回填): supplier_id, settlement_date
溯源统计: column=6, lang=2, 无zh=1 | fe_high=0, enum=1
"""
...
SUPPLIER_CHANGE_SETTLEMENT_DATE_RULE_S: Final[EndpointSpec] = EndpointSpec(
    ...
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='settlement_date', path=f'$.settlement_date', type='string', state='form', ui_kind='text', default='10', description='供应商结算日'),  # zh_ambiguous
