"""fin.home_common.attachment_list —— 孪生生成器产物(请求面;行为面归场景用例)。
...
COMMON_ATTACHMENT_LIST: Final[EndpointSpec] = EndpointSpec(
    id='fin.home_common.attachment_list',
    system='fin',
    service='fin-service',
    name='Common.attachmentList',
    description='Common.attachmentList' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/home/common/attachmentList',
        headers={},
        consumes=[],
        produces=[],
    ),
