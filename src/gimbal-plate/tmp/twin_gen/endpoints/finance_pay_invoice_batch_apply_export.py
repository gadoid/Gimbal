...
PAY_INVOICE_BATCH_APPLY_EXPORT: Final[EndpointSpec] = EndpointSpec(
    ...
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='invoice_time_start', path=f'$.invoice_time_start', type='string', state='form'),
            DeclarationEntry(name='invoice_time_end', path=f'$.invoice_time_end', type='string', state='form'),
