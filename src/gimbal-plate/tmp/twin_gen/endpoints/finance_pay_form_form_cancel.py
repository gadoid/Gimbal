"""fin.pay_form.form_cancel —— 孪生生成器产物(请求面;行为面归场景用例)。
...
PAY_FORM_FORM_CANCEL: Final[EndpointSpec] = EndpointSpec(
    id='fin.pay_form.form_cancel',
    system='fin',
    service='fin-service',
    name='PayForm.formCancel',
    description='PayForm.formCancel' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/payForm/formCancel',
        headers={},
        consumes=[],
        produces=[],
    ),
