...
PAYMENT_FEE_CREATE_PAYMENT_NOTICE: Final[EndpointSpec] = EndpointSpec(
    ...
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='invoice_describe', path=f'$.invoice_describe', type='string', state='carry', ui_kind='textarea', required=True, description='发票说明'),  # needs_capture:value_source
        ],
    ),
    responses={
        200: ResponseSpec(
