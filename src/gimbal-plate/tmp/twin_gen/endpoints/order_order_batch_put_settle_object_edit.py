...
ORDER_BATCH_PUT_SETTLE_OBJECT_EDIT: Final[EndpointSpec] = EndpointSpec(
    id='fin.order_order.batch_put_settle_object_edit',
    system='fin',
    service='fin-service',
    name='Order.batchPutSettleObjectEdit',
    description='Order.batchPutSettleObjectEdit' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/order/order/batchPutSettleObjectEdit',
        headers={},
        consumes=[],
        produces=[],
    ),
