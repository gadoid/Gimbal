...
溯源统计: column=37, 无zh=19, rule=2 | fe_high=0, enum=0
"""
...
CUSTOMER_BATCH_OPERATE_ADD: Final[EndpointSpec] = EndpointSpec(
    ...
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='customer_id', path=f'$.customer_id', type='string', state='carry', ui_kind='text', description='id 主键'),
