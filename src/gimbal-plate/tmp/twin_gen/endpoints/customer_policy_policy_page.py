"""fin.customer_policy.policy_page —— 孪生生成器产物(请求面;行为面归场景用例)。
...
POLICY_POLICY_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.customer_policy.policy_page',
    system='fin',
    service='fin-service',
    name='Policy.policyPage',
    description='Policy.policyPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/customer/policy/policyPage',
        headers={},
        consumes=[],
        produces=[],
    ),
