"""fin.order_fee.customs_real_amount_edit —— 孪生生成器产物(请求面;行为面归场景用例)。
...
ORDER_FEE_CUSTOMS_REAL_AMOUNT_EDIT: Final[EndpointSpec] = EndpointSpec(
    id='fin.order_fee.customs_real_amount_edit',
    system='fin',
    service='fin-service',
    name='操作',
    ...
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/order/orderFee/customsRealAmountEdit',
        headers={},
        consumes=[],
        produces=[],
    ),
