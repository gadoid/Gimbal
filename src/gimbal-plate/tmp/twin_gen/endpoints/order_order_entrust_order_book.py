...
溯源统计: column=129, rule=45, lang=23, frontend=9, 无zh=8, derived=2, header=1 | fe_high=93, enum=0
"""
...
ORDER_ENTRUST_ORDER_BOOK: Final[EndpointSpec] = EndpointSpec(
    ...
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='status', path=f'$.status', type='integer', state='carry', ui_kind='number', default='2', description='订单状态'),  # zh_ambiguous
