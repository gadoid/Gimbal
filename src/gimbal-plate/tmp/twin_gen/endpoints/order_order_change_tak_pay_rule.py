"""fin.order.change_tak_pay_rule —— 孪生生成器产物(请求面;行为面归场景用例)。
...
ORDER_CHANGE_TAK_PAY_RULE: Final[EndpointSpec] = EndpointSpec(
    id='fin.order.change_tak_pay_rule',
    system='fin',
    service='fin-service',
    name='操作目的',
    ...
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='pay_date', path=f'$.pay_date', type='integer', state='form', default='0', description='应付日'),
            DeclarationEntry(name='take_date', path=f'$.take_date', type='integer', state='form', default='0', description='应收日'),
            ...
            DeclarationEntry(name='customer_main_name', path=f'$.customer_main_name', type='string', state='form', description='对客主体'),
            ...
            DeclarationEntry(name='supplier_pay_date', path=f'$.supplier_pay_date', type='integer', state='form', default='0', description='应付日'),
