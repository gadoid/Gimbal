"""fin.delivery_receipt.delivery_receipt_page —— 孪生生成器产物(请求面;行为面归场景用例)。
...
DELIVERY_RECEIPT_DELIVERY_RECEIPT_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.delivery_receipt.delivery_receipt_page',
    system='fin',
    service='fin-service',
    name='DeliveryReceipt.deliveryReceiptPage',
    description='DeliveryReceipt.deliveryReceiptPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/customer/deliveryReceipt/deliveryReceiptPage',
        headers={},
        consumes=[],
        produces=[],
    ),
