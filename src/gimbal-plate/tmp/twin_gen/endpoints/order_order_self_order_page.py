"""fin.order_self.order_page —— 孪生生成器产物(请求面;行为面归场景用例)。
...
ORDER_SELF_ORDER_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.order_self.order_page',
    system='fin',
    service='fin-service',
    name='OrderSelf.orderPage',
    description='OrderSelf.orderPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/order/orderSelf/orderPage',
        headers={},
        consumes=[],
        produces=[],
    ),
