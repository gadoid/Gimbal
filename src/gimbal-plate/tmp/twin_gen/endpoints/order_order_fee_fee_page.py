"""fin.order_fee.fee_page —— 孪生生成器产物(请求面;行为面归场景用例)。
...
ORDER_FEE_FEE_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.order_fee.fee_page',
    system='fin',
    service='fin-service',
    name='OrderFee.feePage',
    description='OrderFee.feePage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/order/orderFee/feePage',
        headers={},
        consumes=[],
        produces=[],
    ),
