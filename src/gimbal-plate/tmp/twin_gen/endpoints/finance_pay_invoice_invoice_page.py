...
PAY_INVOICE_INVOICE_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.pay_invoice.invoice_page',
    system='fin',
    service='fin-service',
    name='PayInvoice.invoicePage',
    description='PayInvoice.invoicePage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/payInvoice/invoicePage',
        headers={},
        consumes=[],
        produces=[],
    ),
