"""fin.pay_invoice_batch.batchpage —— 孪生生成器产物(请求面;行为面归场景用例)。
...
PAY_INVOICE_BATCH_BATCHPAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.pay_invoice_batch.batchpage',
    system='fin',
    service='fin-service',
    name='PayInvoiceBatch.batchpage',
    description='PayInvoiceBatch.batchpage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/payInvoiceBatch/batchpage',
        headers={},
        consumes=[],
        produces=[],
    ),
