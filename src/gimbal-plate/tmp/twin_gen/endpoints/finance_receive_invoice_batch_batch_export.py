"""fin.receive_invoice_batch.batch_export —— 孪生生成器产物(请求面;行为面归场景用例)。
...
溯源统计: frontend=19, lang=5, builtin=2, 无zh=1, column=1 | fe_high=24, enum=0
"""
...
RECEIVE_INVOICE_BATCH_BATCH_EXPORT: Final[EndpointSpec] = EndpointSpec(
    id='fin.receive_invoice_batch.batch_export',
    system='fin',
    service='fin-service',
    name='ReceiveInvoiceBatch.batchExport',
    description='ReceiveInvoiceBatch.batchExport' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/receiveInvoiceBatch/batchExport',
        headers={},
        consumes=[],
        produces=[],
    ),
