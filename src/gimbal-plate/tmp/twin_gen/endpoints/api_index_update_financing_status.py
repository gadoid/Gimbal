"""fin.index.update_financing_status —— 孪生生成器产物(请求面;行为面归场景用例)。
...
INDEX_UPDATE_FINANCING_STATUS: Final[EndpointSpec] = EndpointSpec(
    id='fin.index.update_financing_status',
    system='fin',
    service='fin-service',
    name='Index.updateFinancingStatus',
    description='Index.updateFinancingStatus' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/api/index/updateFinancingStatus',
        headers={},
        consumes=[],
        produces=[],
    ),
