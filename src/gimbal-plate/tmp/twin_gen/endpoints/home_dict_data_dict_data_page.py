"""fin.dict_data.dict_data_page —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): dict_code, status, sort_field, sort_order
溯源统计: builtin=4, frontend=3, column=1 | fe_high=4, enum=1
"""
...
DICT_DATA_DICT_DATA_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.dict_data.dict_data_page',
    system='fin',
    service='fin-service',
    name='DictData.dictDataPage',
    description='DictData.dictDataPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/home/dictData/dictDataPage',
        headers={},
        consumes=[],
        produces=[],
    ),
