"""fin.receive_account.amount_receive_account_edit —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): main_id, customer_id, put_settle_object_id, main_name, put_settle_object, account_batch_name
溯源统计: column=31, 无zh=17, lang=3 | fe_high=0, enum=1
"""
...
RECEIVE_ACCOUNT_AMOUNT_RECEIVE_ACCOUNT_EDIT: Final[EndpointSpec] = EndpointSpec(
    id='fin.receive_account.amount_receive_account_edit',
    system='fin',
    service='fin-service',
    name='操作',
    ...
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/receiveAccount/amountReceiveAccountEdit',
        headers={},
        consumes=[],
        produces=[],
    ),
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='receive_account_no', path=f'$.receive_account_no', type='string', state='form', ui_kind='text', description='对账批次id'),
            ...
            DeclarationEntry(name='business_main_name', path=f'$.business_main_name', type='string', state='carry', ui_kind='text', description='对商主体'),
            ...
            DeclarationEntry(name='book_supplier_name', path=f'$.book_supplier_name', type='string', state='carry', ui_kind='textarea', description='订舱代理'),
            ...
            DeclarationEntry(name='pay_settle_object_id', path=f'$.pay_settle_object_id', type='string', state='carry', ui_kind='text'),
            DeclarationEntry(name='pay_settle_object', path=f'$.pay_settle_object', type='string', state='carry', ui_kind='textarea', description='应付结算对象名称'),
            ...
            DeclarationEntry(name='account_by', path=f'$.account_by', type='integer', state='carry', ui_kind='number'),
