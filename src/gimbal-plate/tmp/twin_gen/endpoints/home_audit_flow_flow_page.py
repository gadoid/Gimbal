"""fin.audit_flow.flow_page —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): sort_field, sort_order
溯源统计: builtin=4, lang=1 | fe_high=0, enum=1
"""
...
AUDIT_FLOW_FLOW_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.audit_flow.flow_page',
    system='fin',
    service='fin-service',
    name='AuditFlow.flowPage',
    description='AuditFlow.flowPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/home/auditFlow/flowPage',
        headers={},
        consumes=[],
        produces=[],
    ),
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='flow_name', path=f'$.flow_name', type='string', state='form', ui_kind='text', description='审批名称'),
