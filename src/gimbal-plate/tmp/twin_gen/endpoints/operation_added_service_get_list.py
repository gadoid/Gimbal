"""fin.added_service.get_list —— 孪生生成器产物(请求面;行为面归场景用例)。
...
ADDED_SERVICE_GET_LIST: Final[EndpointSpec] = EndpointSpec(
    id='fin.added_service.get_list',
    system='fin',
    service='fin-service',
    name='AddedService.getList',
    description='AddedService.getList' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/operation/addedService/getList',
        headers={},
        consumes=[],
        produces=[],
    ),
