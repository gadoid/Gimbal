"""fin.pay_account.pay_account_page —— 孪生生成器产物(请求面;行为面归场景用例)。
...
PAY_ACCOUNT_PAY_ACCOUNT_PAGE: Final[EndpointSpec] = EndpointSpec(
    id='fin.pay_account.pay_account_page',
    system='fin',
    service='fin-service',
    name='PayAccount.payAccountPage',
    description='PayAccount.payAccountPage' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/payAccount/payAccountPage',
        headers={},
        consumes=[],
        produces=[],
    ),
