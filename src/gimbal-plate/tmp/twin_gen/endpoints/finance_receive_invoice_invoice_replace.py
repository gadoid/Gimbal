"""fin.receive_invoice.invoice_replace —— 孪生生成器产物(请求面;行为面归场景用例)。

来源: 代码生成 | 基线: fin-test@2026-09-15 | 生成时间: 2026-09-20T04:38:13+00:00
needs_capture(首跑经 gimbal 执行回填): receive_invoice_id, invoice_number, invoice_type, invoice_amount, invoice_tax_amount, invoice_date, currency, invoice_exchange_rate, buyer_chinese_header, buyer_identifier_no, seller_chinese_header, seller_identifier_no
...
RECEIVE_INVOICE_INVOICE_REPLACE: Final[EndpointSpec] = EndpointSpec(
    id='fin.receive_invoice.invoice_replace',
    system='fin',
    service='fin-service',
    name='ReceiveInvoice.invoiceReplace',
    description='ReceiveInvoice.invoiceReplace' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/receiveInvoice/invoiceReplace',
        headers={},
        consumes=[],
        produces=[],
    ),
