...
needs_capture(首跑经 gimbal 执行回填): invoice_type, invoice_amount, invoice_tax_amount, invoice_date, currency, buyer_chinese_header, buyer_identifier_no, seller_chinese_header, seller_identifier_no
"""
