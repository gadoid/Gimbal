...
溯源统计: column=10, 无zh=2 | fe_high=1, enum=0
"""
...
POST_POST_EDIT: Final[EndpointSpec] = EndpointSpec(
    ...
    request=RequestSpec(
        ...
        declarations=[
            ...
            DeclarationEntry(name='post_id', path=f'$.post_id', type='integer', state='form', ui_kind='number', description='岗位ID'),
            DeclarationEntry(name='operator', path=f'$.operator', type='string', state='form', ui_kind='text'),
            DeclarationEntry(name='post_sort', path=f'$.post_sort', type='integer', state='form', ui_kind='number', description='显示顺序'),
