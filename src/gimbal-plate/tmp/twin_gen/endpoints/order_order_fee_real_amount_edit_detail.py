"""fin.order_fee.real_amount_edit_detail —— 孪生生成器产物(请求面;行为面归场景用例)。
...
溯源统计: column=190, 无zh=2, rule=1, lang=1 | fe_high=0, enum=0
"""
...
ORDER_FEE_REAL_AMOUNT_EDIT_DETAIL: Final[EndpointSpec] = EndpointSpec(
    id='fin.order_fee.real_amount_edit_detail',
    system='fin',
    service='fin-service',
    name='OrderFee.realAmountEditDetail',
    description='OrderFee.realAmountEditDetail' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/order/orderFee/realAmountEditDetail',
        headers={},
        consumes=[],
        produces=[],
    ),
