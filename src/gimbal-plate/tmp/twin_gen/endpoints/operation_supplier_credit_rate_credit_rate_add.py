...
溯源统计: lang=9, column=1 | fe_high=0, enum=1
"""
...
SUPPLIER_CREDIT_RATE_CREDIT_RATE_ADD: Final[EndpointSpec] = EndpointSpec(
    ...
    request=RequestSpec(
        body_type='json',
        declarations=[
            DeclarationEntry(name='company_no', path=f'$.company_no', type='string', state='carry', ui_kind='text', required=True, description='订舱供应商'),  # zh_ambiguous, needs_capture:value_source
