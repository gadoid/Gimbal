"""fin.message_board.message_board_list —— 孪生生成器产物(请求面;行为面归场景用例)。
...
MESSAGE_BOARD_MESSAGE_BOARD_LIST: Final[EndpointSpec] = EndpointSpec(
    id='fin.message_board.message_board_list',
    system='fin',
    service='fin-service',
    name='MessageBoard.messageBoardList',
    description='MessageBoard.messageBoardList' + ' [generated:fin-test@2026-09-15]',
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/home/messageBoard/messageBoardList',
        headers={},
        consumes=[],
        produces=[],
    ),
