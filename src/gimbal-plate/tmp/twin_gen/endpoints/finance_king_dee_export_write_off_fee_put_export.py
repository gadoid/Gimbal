"""fin.king_dee_export.write_off_fee_put_export —— 孪生生成器产物(请求面;行为面归场景用例)。
...
KING_DEE_EXPORT_WRITE_OFF_FEE_PUT_EXPORT: Final[EndpointSpec] = EndpointSpec(
    id='fin.king_dee_export.write_off_fee_put_export',
    system='fin',
    service='fin-service',
    name='操作',
    ...
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/kingDeeExport/writeOffFeePutExport',
        headers={},
        consumes=[],
        produces=[],
    ),
