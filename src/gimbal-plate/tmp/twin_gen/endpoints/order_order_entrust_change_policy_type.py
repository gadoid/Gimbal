"""fin.order_entrust.change_policy_type —— 孪生生成器产物(请求面;行为面归场景用例)。
...
ORDER_ENTRUST_CHANGE_POLICY_TYPE: Final[EndpointSpec] = EndpointSpec(
    id='fin.order_entrust.change_policy_type',
    system='fin',
    service='fin-service',
    name='操作',
    ...
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/order/orderEntrust/changePolicyType',
        headers={},
        consumes=[],
        produces=[],
    ),
