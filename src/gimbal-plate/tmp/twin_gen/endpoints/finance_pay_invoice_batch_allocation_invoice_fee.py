"""fin.pay_invoice_batch.allocation_invoice_fee —— 孪生生成器产物(请求面;行为面归场景用例)。
...
PAY_INVOICE_BATCH_ALLOCATION_INVOICE_FEE: Final[EndpointSpec] = EndpointSpec(
    id='fin.pay_invoice_batch.allocation_invoice_fee',
    system='fin',
    service='fin-service',
    name='操作',
    ...
    api=ApiSpec(
        service='fin-service',
        method='POST',
        path='/api/finance/payInvoiceBatch/allocationInvoiceFee',
        headers={},
        consumes=[],
        produces=[],
    ),
