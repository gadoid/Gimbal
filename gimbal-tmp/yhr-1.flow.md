...
- lineage edges: **55**  external matches: **9**  open gaps: **0**
...
| 2 | `/api/order/orderEntrust/orderPage` | produces downstream id(s): order_id, order_no |  |
...
|----:|-------|----------------|-------|-------------|
| 0 | `bl_no` | `$.request_body.bl_no` | `YHRGIMBAL00011` | var.bl_no |
| 1 | `bl_no` | `$.request_body.bl_no` | `YHRGIMBAL00011` | var.bl_no |
| 3 | `bl_no` | `$.request_body.bl_no` | `YHRGIMBAL00011` | var.bl_no |
| 5 | `bl_no` | `$.request_body.bl_no` | `YHRGIMBAL00011` | var.bl_no |
| 6 | `bl_no` | `$.request_body.bl_no` | `YHRGIMBAL00011` | var.bl_no |
| 7 | `bl_no` | `$.request_body.bl_no` | `YHRGIMBAL00011` | var.bl_no |
| 11 | `bl_no` | `$.request_body.bl_no` | `YHRGIMBAL00011` | var.bl_no |
| 12 | `bl_no` | `$.request_body.bl_no` | `YHRGIMBAL00011` | var.bl_no |
| 13 | `bl_no` | `$.request_body.bl_no` | `YHRGIMBAL00011` | var.bl_no |
