...
- script: `D:\Gimbal\Gimbal\gimbal-tmp\director_tmp_run\yhr-1.script.json`
- scaffold: `D:\Gimbal\Gimbal\gimbal-tmp\director_tmp_run\scaffold.modified.json`
- output scenario: `D:\Gimbal\Gimbal\gimbal-tmp\director_tmp_run\yhr-1.scenario.json`
- auth user: `codfish`
- service: `None`
...
|---:|---:|---|---|---|---|---|
| 0 | 100 | POST | `/api/order/orderEntrust/orderPage` | `bl_no` | — | yes |
| 1 | 0 | POST | `/api/order/orderEntrust/orderAdd` | — | `bl_no`→`$.request_body.bl_no` |  |
| 2 | 1 | POST | `/api/order/orderEntrust/orderAdd` | — | `bl_no`→`$.request_body.bl_no` |  |
| 3 | 2 | POST | `/api/order/orderEntrust/orderPage` | `order_id`, `order_no` | — |  |
| 4 | 4 | POST | `/api/order/order/orderDetail` | `order_supplier_id` | `order_id`→`$.request_body.order_id` |  |
| 5 | 5 | POST | `/api/order/orderEntrust/orderAdd` | — | `bl_no`→`$.request_body.bl_no`, `order_supplier_id`→`$.request_body.supplier[0].order_supplier_id`, `order_id`→`$.request_body.supplier[0].order_id`, `order_id`→`$.request_body.order_id`, `order_no`→`$.request_body.order_no` |  |
| 6 | 6 | POST | `/api/order/orderEntrust/orderAdd` | — | `bl_no`→`$.request_body.bl_no`, `order_supplier_id`→`$.request_body.supplier[0].order_supplier_id`, `order_id`→`$.request_body.supplier[0].order_id`, `order_id`→`$.request_body.order_id`, `order_no`→`$.request_body.order_no` |  |
| 7 | 10 | POST | `/api/order/order/orderDetail` | `order_container_id` | `order_id`→`$.request_body.order_id` |  |
| 8 | 11 | POST | `/api/order/order/orderAdd` | — | `bl_no`→`$.request_body.bl_no`, `order_container_id`→`$.request_body.container[0].order_container_id`, `order_supplier_id`→`$.request_body.supplier[0].order_supplier_id`, `order_id`→`$.request_body.supplier[0].order_id`, `order_id`→`$.request_body.order_id`, `order_no`→`$.request_body.order_no` |  |
| 9 | 12 | POST | `/api/order/order/orderBook` | `file_id` | `bl_no`→`$.request_body.bl_no`, `order_container_id`→`$.request_body.container[0].order_container_id`, `order_supplier_id`→`$.request_body.supplier[0].order_supplier_id`, `order_id`→`$.request_body.supplier[0].order_id`, `order_id`→`$.request_body.order_id`, `order_no`→`$.request_body.order_no` |  |
| 10 | 13 | POST | `/api/order/order/orderAdd` | — | `bl_no`→`$.request_body.bl_no`, `order_container_id`→`$.request_body.container[0].order_container_id`, `file_id`→`$.request_body.customer_file_list[0].file_id`, `order_supplier_id`→`$.request_body.supplier[0].order_supplier_id`, `order_id`→`$.request_body.supplier[0].order_id`, `order_id`→`$.request_body.order_id`, `order_no`→`$.request_body.order_no` |  |
| 11 | 14 | POST | `/api/order/order/orderPage` | `code` | — |  |
| 12 | 16 | POST | `/api/order/orderFee/toggleRealAmount` | — | `order_id`→`$.request_body.order_id` |  |
| 13 | 17 | POST | `/api/order/orderFee/bookRealAmountEdit` | — | `order_id`→`$.request_body.order_id` |  |
| 14 | 18 | POST | `/api/order/orderFee/bookRealAmountEdit` | — | `order_id`→`$.request_body.order_id` |  |
| 15 | 21 | POST | `/api/order/order/checkGenerateOrderSub` | — | `order_id`→`$.request_body.order_id` |  |
| 16 | 22 | POST | `/api/order/order/generateOrderSub` | — | `order_id`→`$.request_body.order_id` |  |
| 17 | 24 | POST | `/api/order/orderFee/toggleRealAmount` | `order_fee_real_ids` | `order_id`→`$.request_body.order_id` |  |
| 18 | 25 | POST | `/api/order/orderFee/realAmountLockSubmit` | — | `order_id`→`$.request_body.order_id`, `order_fee_real_ids`→`$.request_body.order_fee_real_ids[0]` |  |
| 19 | 26 | POST | `/api/order/orderFee/realAmountLockSubmit` | — | `order_id`→`$.request_body.order_id`, `order_fee_real_ids`→`$.request_body.order_fee_real_ids[0]` |  |
| 20 | 27 | POST | `/api/order/orderFee/realAmountLockSubmit` | — | `order_id`→`$.request_body.order_id`, `order_fee_real_ids`→`$.request_body.order_fee_real_ids[0]`, `code`→`$.request_body.audit_msg.code` |  |
| 21 | 29 | POST | `/api/order/order/orderDetail` | `audit_id` | `order_id`→`$.request_body.order_id` |  |
| 22 | 33 | POST | `/api/home/audit/auditExecute` | — | `audit_id`→`$.request_body.audit_ids[0]` |  |
| 23 | 38 | POST | `/api/order/order/orderDetail` | `audit_id_2` | `order_id`→`$.request_body.order_id` |  |
| 24 | 42 | POST | `/api/home/audit/auditExecute` | — | `audit_id_2`→`$.request_body.audit_ids[0]` |  |
...
**Step 1 (idx=0, POST `/api/order/orderEntrust/orderAdd`)**
...
**Step 2 (idx=1, POST `/api/order/orderEntrust/orderAdd`)**
...
**Step 3 (idx=2, POST `/api/order/orderEntrust/orderPage`)**
...
**Step 4 (idx=4, POST `/api/order/order/orderDetail`)**

| jsonpath | literal |
|---|---|
| `$.order_id` | `330576955302739968` |

**Step 5 (idx=5, POST `/api/order/orderEntrust/orderAdd`)**
...
**Step 6 (idx=6, POST `/api/order/orderEntrust/orderAdd`)**
...
**Step 7 (idx=10, POST `/api/order/order/orderDetail`)**

| jsonpath | literal |
|---|---|
| `$.order_id` | `330576955302739968` |

**Step 8 (idx=11, POST `/api/order/order/orderAdd`)**
...
**Step 9 (idx=12, POST `/api/order/order/orderBook`)**
...
**Step 10 (idx=13, POST `/api/order/order/orderAdd`)**
...
**Step 11 (idx=14, POST `/api/order/order/orderPage`)**
...
**Step 12 (idx=16, POST `/api/order/orderFee/toggleRealAmount`)**

| jsonpath | literal |
|---|---|
| `$.order_id` | `330576955302739968` |

**Step 13 (idx=17, POST `/api/order/orderFee/bookRealAmountEdit`)**
...
**Step 14 (idx=18, POST `/api/order/orderFee/bookRealAmountEdit`)**
...
**Step 15 (idx=21, POST `/api/order/order/checkGenerateOrderSub`)**

| jsonpath | literal |
|---|---|
| `$.order_id` | `330576955302739968` |

**Step 16 (idx=22, POST `/api/order/order/generateOrderSub`)**

| jsonpath | literal |
|---|---|
| `$.order_id` | `330576955302739968` |

**Step 17 (idx=24, POST `/api/order/orderFee/toggleRealAmount`)**

| jsonpath | literal |
|---|---|
| `$.order_id` | `330576955302739968` |

**Step 18 (idx=25, POST `/api/order/orderFee/realAmountLockSubmit`)**
...
**Step 19 (idx=26, POST `/api/order/orderFee/realAmountLockSubmit`)**
...
**Step 20 (idx=27, POST `/api/order/orderFee/realAmountLockSubmit`)**
...
**Step 21 (idx=29, POST `/api/order/order/orderDetail`)**

| jsonpath | literal |
|---|---|
| `$.order_id` | `330576955302739968` |

**Step 22 (idx=33, POST `/api/home/audit/auditExecute`)**

| jsonpath | literal |
|---|---|
| `$.audit_ids[0]` | `330577547932729344` |

**Step 23 (idx=38, POST `/api/order/order/orderDetail`)**

| jsonpath | literal |
|---|---|
| `$.order_id` | `330576955302739968` |

**Step 24 (idx=42, POST `/api/home/audit/auditExecute`)**
