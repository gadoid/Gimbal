...
await page.locator('.el-input__inner').first().fill('dbg-dlg')
...
const info = await page.evaluate(() => ({
  ...
  footerBtns: [...document.querySelectorAll('.el-dialog__footer button')].map((b) => b.textContent?.trim()),
  allDialogBtns: [...document.querySelectorAll('.el-dialog button')].map((b) => b.textContent?.trim()),
}))
