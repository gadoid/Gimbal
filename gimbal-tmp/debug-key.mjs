...
await page.locator('.el-input__inner').first().fill('dbg-key')
...
await page.waitForTimeout(500)
console.log('dialog:', await page.evaluate(() => !!document.querySelector('.el-dialog')))
await page.locator('.el-dialog .el-select').click()
await page.waitForTimeout(500)
const items = await page.evaluate(() => [...document.querySelectorAll('.el-select-dropdown__item')].slice(0, 5).map((i) => i.textContent?.trim()))
