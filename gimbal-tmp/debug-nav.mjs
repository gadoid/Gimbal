...
console.log('1. url after goto step=4:', page.url())
...
console.log('2. url after join:', page.url())
const state = await page.evaluate(() => ({
  stepNavActive: document.querySelector('.step-nav .active, .wizard-step.active')?.textContent?.trim(),
  hasStrategyForm: !!document.querySelector('.strategy-form'),
  hasAddStrategy: !!document.querySelector('.add-strategy'),
  hasExtract: !!document.querySelector('.add-extract'),
