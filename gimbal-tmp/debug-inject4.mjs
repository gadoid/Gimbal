...
// window.onerror 捕获渲染错误本体
await page.exposeFunction('reportErr', (msg, src, line, col, errStack) => {
  console.log('WINDOW.ONERROR:', msg)
  if (errStack) console.log('STACK:', String(errStack).slice(0, 600))
})
await page.evaluateOnNewDocument(() => {
  window.addEventListener('error', (e) => {
    // @ts-ignore
    window.reportErr?.(String(e.message), '', 0, 0, e.error?.stack || '')
  })
})
await page.goto(`${BASE}/composer/new`, { waitUntil: 'domcontentloaded' })
await page.waitForTimeout(1000)
await page.locator('.el-input__inner').first().fill('dbg4')
